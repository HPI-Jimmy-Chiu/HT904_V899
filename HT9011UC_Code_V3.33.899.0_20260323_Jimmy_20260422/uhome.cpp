...
//                flag1=false;
            ...
            //AI(ht9045-v899) 20260703: Greatek�w�鷥�ʮե�-Home�H��}���ؼ�;���L�̳n��fHasTray��������,�L�L�h�X�ʩ�}�ýT�{FixOff���(���A��FixOn sensor�q���L,FixOn ON=�ŧ��D���L);�DGreatek�������޿�
            if(CUSTOMER_CODE==CC_Greatek && USE_AUTO_RETEST==eartInstall)
            {
                if(MOT[MTrayX].fHasTray)
                {
                    Cylinder[C_CatchTray_FixOn].On();       //�n��T�����L:��������
                    Cylinder[C_CatchTray_FixOff].Off();
                }
                else
                {
                    Cylinder[C_CatchTray_FixOn].Off();       //�L�L:�ؼЩ�}
                    Cylinder[C_CatchTray_FixOff].On();
                    if(Cylinder[C_CatchTray_FixOff].OnStatus()==false)   //��}�����:�X�ʫᤴ�d
                    {
