...
void __fastcall TfCleaning::LoadAutoCleanData()
{
    ...
    TestIF_File.dAutoClean_InArmVacuum          =ReadIniData(szDir, "AutoClean", "InArmVacuum",            1.00);         //Steven 20250319 : Auto Clean使用另外一組Delay Time //AI(ht9045-v899) 20260423: Greatek要求 default 60->1 (CASE-20260423-001)
    TestIF_File.dAutoClean_InArmAirOn           =ReadIniData(szDir, "AutoClean", "InArmAirOn",             1.00); //AI(ht9045-v899) 20260423: Greatek要求 default 60->1 (CASE-20260423-001)
    TestIF_File.dAutoClean_IndexVacuum          =ReadIniData(szDir, "AutoClean", "IndexVacuum",            1.00); //AI(ht9045-v899) 20260423: Greatek要求 default 60->1 (CASE-20260423-001)
    TestIF_File.dAutoClean_IndexAirOn           =ReadIniData(szDir, "AutoClean", "IndexAirOn",             1.00); //AI(ht9045-v899) 20260423: Greatek要求 default 60->1 (CASE-20260423-001)
    ...
    if(CosFunction.bSetContactForceToAutoClean==true)                           //Steven 20250915 : 複製Contact Force給Auto Clean用
    {
        ...
        if(INSTALL_DOUBLE_EP==DOUBLE_EP_NORMAL || INSTALL_DOUBLE_EP==DOUBLE_EP_MULTI)                        //AI(ht9045-v899) 20260430: extend AutoClean DieForce to Multi EP half.
...
void __fastcall TfCleaning::FormShow(TObject *Sender)
{
    ...
    grpDieForce->Visible=(INSTALL_DOUBLE_EP==DOUBLE_EP_NORMAL || INSTALL_DOUBLE_EP==DOUBLE_EP_MULTI);        //Steven 20240719 : Die force for auto clean //AI(ht9045-v899) 20260430: extend to Multi EP half.
