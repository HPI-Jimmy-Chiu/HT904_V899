...
//                    }
    ...
    if(INSTALL_DOUBLE_EP==DOUBLE_EP_INDIVIAL && TestIF_File.iTestMode==DualSite)                            //AI(ht9045-v899) 20260504: split INDIVIAL/MULTI gating per V896 (Ifor 20250416). MULTI covers <=QualSite2X2N.
        TestIF_File.bIndEPSLK=ReadIniData(szDir, "Configuration", "bIndEPSLK",  false);
    else if(INSTALL_DOUBLE_EP==DOUBLE_EP_MULTI && TestIF_File.iTestMode<=QualSite2X2N)
        TestIF_File.bIndEPSLK=ReadIniData(szDir, "Configuration", "bIndEPSLK",  false);
    else
