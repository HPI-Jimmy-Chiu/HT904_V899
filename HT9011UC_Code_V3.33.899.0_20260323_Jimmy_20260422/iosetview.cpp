...
void __fastcall Tfiosetview::Timer1Timer(TObject *Sender)
{
       ...
       //&& (CUSTOMER_CODE!=CC_Greatek || IniConfig.bN14HandlerOEEUseFunction==false)) //Sam 20190521 : 正賢要求不要讀取，會與 OEE 的功能相衝
    {
        ...
        if(INSTALL_DOUBLE_EP==DOUBLE_EP_NORMAL || INSTALL_DOUBLE_EP==DOUBLE_EP_MULTI)                        //Ifor 20190104 : Add Double EP Control //AI(ht9045-v899) 20260430: extend EP voltage display to Multi EP half (Address[2] 172.16.8.112, physical 2nd board).
        {
    ...
    if(Enable_PLCSafety_IO==true)                                               //ben 20230823 for SafePLC
    {
        RefreshSafePLCLed();
    }
...
void __fastcall Tfiosetview::FormShow(TObject *Sender)
{
    ...
    tsSafePLC->TabVisible=Enable_PLCSafety_IO;                                  //ben 20230823 for SafePLC
...
//        btnpnlnIndexIONFan          ->Visible = (ATC_SYSTEM!=eATCUninstall);  //jou 2012-03-08 Enable ATC mode;
        ...
        gbDoubleEP                  ->Visible = (INSTALL_DOUBLE_EP);            //Ifor 20190104 : Add Double EP Control
    ...
    gpSafePLC->Visible              =(Enable_PLCSafety_IO==1);                  //KenHsieh 20250212 : 新增PLC 斷線可瞬間判斷EMG及安全門
