#ifndef cpublicH
#define cpublicH
#include "vclcompat/vcl_compat.h"   //AI(W0-TAIL) 20260626: AnsiString/IntToHex (was <vcl.h> via includer)
#include <windows.h>                 //AI(W0-TAIL) 20260626: WORD/DWORD/__int64/VS_FIXEDFILEINFO/LPCTSTR (was via includer)
...
class VerInfo                                                                   //Sam 20230328 : 自動更新增加版本檢查
{
    public:
        VerInfo();
        AnsiString FileName() const { return m_strFileName; } void SetFileName(AnsiString v){ m_SetFileName(v); } //AI(W0-TAIL) 20260626: __property->getter/setter   //檔案名稱
        AnsiString FixedFileVersion() { return m_strGetFixedFileVersion(); } //AI(W0-TAIL) 20260626: __property->getter                //檔案版本
        WORD LangID() const { return m_wLangID; } //AI(W0-TAIL) 20260626: __property->getter                               //語系
        WORD CharsetID() const { return m_wCharsetID; } //AI(W0-TAIL) 20260626: __property->getter                            //字元表
        AnsiString ProductName() const { return m_strProductName; } //AI(W0-TAIL) 20260626: __property->getter                        //產品名稱
        AnsiString ProductVersion() const { return m_strProductVersion; } //AI(W0-TAIL) 20260626: __property->getter                     //產品版本
        AnsiString OriginalFilename() const { return m_strOriginalFilename; } //AI(W0-TAIL) 20260626: __property->getter                  //原始檔名
        AnsiString FileDescription() const { return m_strFileDescription; } //AI(W0-TAIL) 20260626: __property->getter                    //檔案說明
        AnsiString CompanyName() const { return m_strCompanyName; } //AI(W0-TAIL) 20260626: __property->getter                        //公司名稱
        AnsiString LegalCopyright() const { return m_strLegalCopyright; } //AI(W0-TAIL) 20260626: __property->getter                     //著作權
        AnsiString LegalTrademarks() const { return m_strLegalTrademarks; } //AI(W0-TAIL) 20260626: __property->getter                    //合法商標
        AnsiString InternalName() const { return m_strInternalName; } //AI(W0-TAIL) 20260626: __property->getter                       //內部名稱
        AnsiString Comments() const { return m_strComments; } //AI(W0-TAIL) 20260626: __property->getter                           //說明
