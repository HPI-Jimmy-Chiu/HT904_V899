// =============================================================================
//  aoutarm9045_1x1_1.cpp  --  Out-Arm per-site VARIANT (1x1_1, single-site)
//
//  Faithful translation of golden aoutarm9045_1x1_1.cpp (1177 lines, BCB6, Big5).
//  Translator: AI(W6.2c-1x1_1) 20260627
//  Translation wave: W6.2c (out-arm per-site-config variant: 1x1_1).  This is the
//  LIVE single-site out-arm callee: the engine dispatch ladder in aoutarm9045.cpp
//  routes BOTH iInArmType==e9045_1x1_1 AND iInArmType==e9045_1x4_1_Ac to
//  DoOutArm_9045_1x1_1() / DoPickFromShuttle_9045_1x1_1(int) (this file's two
//  engine-dispatched callees -- the file's layout suffix == the callee suffix).
//
//  ROLE: the per-site out-arm pick-from-shuttle / place-to-auto state machines for
//  the 1x1_1 layout (single picker, suck row/col fixed 0,0).  This file owns:
//    OutArmZNeedDown_1x1_1, CheckOutArmXYPitch_1x1_1,
//    MoveOutArmToShuttleIncludeZ_9045_1x1_1, DoPickFromShuttle_9045_1x1_1,
//    DoOutArm_9045_1x1_1, and the file-scope global TQPF_Timer DoATCHeatGunDelay[2].
//
...
//  the integer-vs-double pitch math (double(iMovePitchX)/7.0 etc.), and the
//  commented-out #ifdef Carry4 / iOutArmPickPlaceCnt blocks are transcribed
//  VERBATIM from the golden CP950.  The SM case bodies are ACTIVE -- they touch
...
//  DoPickFromShuttle_9045_1x1_1 (fMain->chkInPickLoadError simulate-IC-lost) is
//  kept VERBATIM but inert.  Numeric semantics (int vs double, integer division/
//  truncation) kept EXACT.
//
//  GATED (// TODO(W7)): the two fFixAICCD->OutArmCycleCounterUpdate() Fix-AI-CCD
//  UI calls (golden FixAICCD.h TfFixAICCD form; no FormsFacade stand-in) are
//  gated behind `#if 0 // TODO(W7)` -- the surrounding
...
#include "cmydef.h"                // global scalar universe + IC consts + iInArmType + enums + AseIcRecord / bPickSH*Flag / bMagCatchTrayfalg / iWhich* / iAutoIndex / SnFixedTrayDetect / ...
...
//     OutArmAddSpeedDisplay, OutArmTask, CheckOutArmCleanOut.
//   golden home -> aoutarm9045.h, but OMITTED from this wave's translated subset:
//     GetOutArmYToShuttleOffset_9045, GetOutArmXToShuttleOffset_9045,
//     GetVariableYOutShuttleData, SwapShuttleDataToOutArm, bOutSuckShtDupErr,
//     iOutShtRetryCount, iPickFromShuttle1Task, iPickFromShuttle2Task,
//     CheckOutArmToTask50, DoFixTrayFullAlarm, VerifyTrayStatus,
...
//   unaffected for this single-site variant.
// -----------------------------------------------------------------------------
...
int GetOutArmXToShuttleOffset_9045(int iSht, int iOffsetPos);                  //Steven 20240309 : fixed for ...
#endif
...
//  Ver : 2003_07
//==============================================================================
// provenance: golden aoutarm9045_1x1_1.cpp:36 (OutArmZNeedDown_1x1_1)
...
//------------------------------------------------------------------------------
// provenance: golden aoutarm9045_1x1_1.cpp:51 (CheckOutArmXYPitch_1x1_1)
...
//==============================================================================
// provenance: golden aoutarm9045_1x1_1.cpp:113 (MoveOutArmToShuttleIncludeZ_9045_1x1_1)
...
// provenance: golden aoutarm9045_1x1_1.cpp:180 (DoPickFromShuttle_9045_1x1_1)
...
//==============================================================================
// provenance: golden aoutarm9045_1x1_1.cpp:404 (DoOutArm_9045_1x1_1)
