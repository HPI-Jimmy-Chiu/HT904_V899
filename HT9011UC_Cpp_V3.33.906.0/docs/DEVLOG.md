...
- **▶ OUT-ARM 變體 fan-out 進行中（26 檔，「跑全部」campaign）**：engine aoutarm9045.cpp dispatch ladder 已 active 呼叫 per-layout callee，目前 resolve 到 `static` no-op stub。整合（live）=加 CMake+移除該變體 2 個 static stub+un-gate 2 extern；dead 檔只加 CMake（never dispatched，如 in-arm 2x8_32）。**20 live callee 檔**(1x1_1/1x2_2/1x2_4/1x3_2_14/1x3_4/1x4_2/1x4_4S/1x4_4/1x4_8/2x1_2/2x2_4/2x2_8/2x3_6_14/2x3_6/2x4_4/2x4_8/2x5_8/2x6_8/2x8_8/All_1Picker) + **6 dead 檔**(1x4_4_Back/2x2_4_14/2x2_4_23/2x4_16/2x8_16/2x8_32)。enum→callee 映射見 batch-5 段。分 5 批(B1-B4 live + B5 dead)，reusable script `w62_outarm_variant_batch.js`(改 BATCH/MODE)。之後 W7。
