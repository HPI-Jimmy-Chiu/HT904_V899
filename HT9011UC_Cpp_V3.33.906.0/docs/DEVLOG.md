...
- **▶ 剩 2 個 gated in-arm dispatch 入口（小型後續波）**：`e9045_1x4_4_13→DoInArm_9045S_1x4_4`、`e9045_2x4_4_13→DoInArm_9045_2x4_4_13`，callee 在獨立 `ainarm9045S_*` 檔家族(golden `ainarm9045S_1x4_4.cpp`/`ainarm9045S_2x4_4_13.cpp`，未翻)。之後 **26 個 out-arm 變體**(同三段式架構)、W7。
