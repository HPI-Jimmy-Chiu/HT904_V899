// =============================================================================
//  aoutarm9045_1x4_4S.cpp  --  Out-Arm per-site VARIANT (1x4_4S, single-row 4-picker)
//
//  Faithful translation of golden aoutarm9045_1x4_4S.cpp (52363 bytes, BCB6, Big5/cp950).
...
//  1x4_4S layout.  This file owns (golden names VERBATIM):
//    GetNowShuttleMode_9045_1x4_4S, OutArmZNeedDown_9045_1x4_4S,
//    CheckOutArmXYPitch_9045_1x4_4S, MoveOutArmToShuttleIncludeZ_9045_1x4_4S,
//    DoPickFromShuttle_9045_1x4_4S, DoOutArm_9045_1x4_4S.
//  NAMING NOTE: this layout's pure helpers carry the _9045_ infix (unlike the
//  other six out-arm variants) -- preserved VERBATIM.
//
//  ENGINE DISPATCH (LIVE variant): the out-arm engine aoutarm9045.cpp routes
//  iInArmType==e9045_1x4_4_13 -> DoOutArm_9045_1x4_4S() (dispatch ladder line 510)
//  and DoPickFromShuttle_9045_1x4_4S(int) (line 642).  The file layout suffix ==
//  the callee suffix (ENUM->CALLEE map: 1x4_4_13 -> 1x4_4S).
//
...
//  CP950 source.  The DoOutArm_9045_1x4_4S case-3301 fall-through into case-3500,
...
//    golden: MachineDefine.h ; aoutarm9045_1x4_4S.h ; aArmHeader.h ; MyKitSuck.h ;
...
#include "MachineType.h"            // e9045_1x4_4_13 / ep16Picker / eBulkBox / CC_KYEC_LEE / CC_TSMC_TAINAN global enums
//---------------------------------------------------------------------------
...
#include "csystem.h"                // OutSHT1InRT / OutSHT2InRT / HasICUnderMachine / HasICUnderHotPlate / AutoTrayReCheck / CheckOutArmSuckICFallDown
...
//==============================================================================
#ifndef OUTARM_1x4_4S_FWD_GUARD
#define OUTARM_1x4_4S_FWD_GUARD
...
// NOTE: PreSetOutAdditionalFlag / DoOutArmPlaceToAuto_9045 / DoOutArmAdditionalFunction /
//       DoOutArmAfterPlaceToAuto / VerifyFixTrayLink / CheekNeedToDoOutArmAdditionalFunction /
//       SearchTrayToPlace_9045 are declared in aoutarm9045.h (engine header) -- not re-declared.
...
#endif // OUTARM_1x4_4S_FWD_GUARD

//==============================================================================
//==  CheckDuplicateBarCode() -- NEW shim symbol this batch needs (serial Integrate
//==  adds `bool CheckDuplicateBarCode(){return true;}` to aoutarm_shims.cpp).
//==  Golden home aoutarm.h:130.  Used ONLY by 1x4_4 in this batch -- 1x4_4S calls
//==  it too at golden case-3000 (guarded by CosFunction.bBarcodeDuplicateFileByOutArm,
//==  false offline).  Forward-declared behind an #ifndef guard so the file compiles
//==  standalone; offline semantics: true (barcode OK / not duplicate).
//==============================================================================
...
//  Ver : 2003_07
//  -- golden aoutarm9045_1x4_4S.cpp:35
//==============================================================================
int GetNowShuttleMode_9045_1x4_4S(int iSht)
{
...
//==============================================================================
//  OutArmZNeedDown_9045_1x4_4S  -- golden aoutarm9045_1x4_4S.cpp:52
//==============================================================================
bool OutArmZNeedDown_9045_1x4_4S(int iSht)
{
    if(InitialOutArmNeedSuck(iSht)==false)
        return false;

//    ptrOutSHT=(iSht==0)?&FRCarryKit:&BRCarryKit;
//    int iMode=GetNowShuttleMode_9045_1x4_4S(iSht);
...
//------------------------------------------------------------------------------
//  CheckOutArmXYPitch_9045_1x4_4S  -- golden aoutarm9045_1x4_4S.cpp:107
//------------------------------------------------------------------------------
bool CheckOutArmXYPitch_9045_1x4_4S(int *iX, int *iY, int iSht, int iMovePitchX, int iMovePitchY)
{
    int iMode=GetNowShuttleMode_9045_1x4_4S(iSht);
    int iModeRow=iMode%100;
    int iModeCol=iMode/100;
...
//    }
    ...
    *iX=*iX+GetOutArmXToShuttleOffset_9045(iSht, iOffsetPos);
    ...
    if(OutArmZNeedDown_9045_1x4_4S(iSht)==false)
        return false;
    return true;
}
//==============================================================================
//  MoveOutArmToShuttleIncludeZ_9045_1x4_4S  -- golden aoutarm9045_1x4_4S.cpp:176
//==============================================================================
bool MoveOutArmToShuttleIncludeZ_9045_1x4_4S(int iSht, bool bZDown)
{
    ...
    if(OutArmSuck.iXStep==1)
        ...
        iMovePitchX=TestIF.dSiteXPitch/2;
    else
    ...
    if(CheckOutArmXYPitch_9045_1x4_4S(&iXPos, &iYPos, iSht, iMovePitchX, iMovePitchY)==false && bZDown==true)
        return false;
...
//  Ver : 2003_07
//  -- golden aoutarm9045_1x4_4S.cpp:234
//==============================================================================
    ...
    switch(Task)
    {
        case 1:
            if(ArmSpeed[OutArm].dWaitOnSH!=0)                                   //kevin 20210525 out arm 起動在shuttle 上等待 時間
            {
                ...
                {
                    if(MoveOutArmToShuttleIncludeZ_9045_1x4_4S(iSht, false))    //移到 Shuttle 上等待
                    {
        ...
        case 10:
            ...
            Task=200;
        case 200:
            if(MoveOutArmToShuttleIncludeZ_9045_1x4_4S(iSht, true))             //kevin 20210717 change function
            {
...
//==============================================================================
//  DoOutArm_9045_1x4_4S  -- golden aoutarm9045_1x4_4S.cpp:518
//==============================================================================
...
//                        #endif
        ...
        case 1150:
            ...
            if(MoveOutArmToShuttleIncludeZ_9045_1x4_4S(iWhichShuttle, false))
            {
                IsCatchTrayReadySupplyNewTray();

                if(OutArmSuck.iXStep!=1 || OutArmSuck.iYStep!=1)
                {
                    iBackMode1=GetNowShuttleMode_9045_1x4_4S(0);
                }
...
//#endif
                ...
                if(OutArmSuck.iXStep!=1)
                {
                    iMode1=GetNowShuttleMode_9045_1x4_4S(0);
        ...
        case 1200:
            ...
            IsCatchTrayReadySupplyNewTray();
            if(DoPickFromShuttle_9045_1x4_4S(0))
            {
...
//                        #endif
        ...
        case 2050:
            ...
            if(MoveOutArmToShuttleIncludeZ_9045_1x4_4S(iWhichShuttle, false))
            {
                ...
                if(OutArmSuck.iXStep!=1)
                {
                    iBackMode2=GetNowShuttleMode_9045_1x4_4S(1);
                }
                Task=2100;
            }
...
//#endif
                ...
                if(OutArmSuck.iXStep!=1)
                {
                    iMode2=GetNowShuttleMode_9045_1x4_4S(1);
        ...
        case 2200:
            ...
            if(DoPickFromShuttle_9045_1x4_4S(1))
            {
                PreSetOutAdditionalFlag();                                                                              //Steven 20220614 : Fixed for out arm additional function
...
//#else
                ...
                MOT[MInShuttle2].fCanMoveR=true;
//#endif
                if(CosFunction.bBarcodeDuplicateFileByOutArm==true && CheckDuplicateBarCode()==false)
                {
                    Task=3000;
                    break;
                }
