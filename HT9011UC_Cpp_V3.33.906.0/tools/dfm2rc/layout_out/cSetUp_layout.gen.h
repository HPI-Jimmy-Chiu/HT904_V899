...
//  Source .dfm: cSetUp.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cSetUp -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CSETUP_H
#define HT9045_GEN_LAYOUT_CSETUP_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcSetUpLayout[];
extern const int kcSetUpLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CSETUP_H
