...
//  Source .dfm: iosetview.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for iosetview -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_IOSETVIEW_H
#define HT9045_GEN_LAYOUT_IOSETVIEW_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kiosetviewLayout[];
extern const int kiosetviewLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_IOSETVIEW_H
