...
//  Source .dfm: cShowBinSelect.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cShowBinSelect -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CSHOWBINSELECT_H
#define HT9045_GEN_LAYOUT_CSHOWBINSELECT_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcShowBinSelectLayout[];
extern const int kcShowBinSelectLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CSHOWBINSELECT_H
