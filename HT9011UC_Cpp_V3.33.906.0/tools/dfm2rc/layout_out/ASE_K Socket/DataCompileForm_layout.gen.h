// ===========================================================================
//  ASE_K Socket/DataCompileForm_layout.gen.h
...
//  Source .dfm: ASE_K Socket/DataCompileForm.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for DataCompileForm -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_DATACOMPILEFORM_H
#define HT9045_GEN_LAYOUT_DATACOMPILEFORM_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kDataCompileFormLayout[];
extern const int kDataCompileFormLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_DATACOMPILEFORM_H
