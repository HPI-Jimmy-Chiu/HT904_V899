// ===========================================================================
//  ASE_K Socket/Socket_ASE_KR_layout.gen.h
...
//  Source .dfm: ASE_K Socket/Socket_ASE_KR.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for Socket_ASE_KR -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_SOCKET_ASE_KR_H
#define HT9045_GEN_LAYOUT_SOCKET_ASE_KR_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kSocket_ASE_KRLayout[];
extern const int kSocket_ASE_KRLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_SOCKET_ASE_KR_H
