// ===========================================================================
//  ASE_K Socket/aseTest_layout.gen.h
...
//  Source .dfm: ASE_K Socket/aseTest.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for aseTest -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_ASETEST_H
#define HT9045_GEN_LAYOUT_ASETEST_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kaseTestLayout[];
extern const int kaseTestLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_ASETEST_H
