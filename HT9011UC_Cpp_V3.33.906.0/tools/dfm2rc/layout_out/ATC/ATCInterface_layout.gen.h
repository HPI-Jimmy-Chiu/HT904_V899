...
//  Source .dfm: ATC/ATCInterface.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for ATCInterface -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_ATCINTERFACE_H
#define HT9045_GEN_LAYOUT_ATCINTERFACE_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kATCInterfaceLayout[];
extern const int kATCInterfaceLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_ATCINTERFACE_H
