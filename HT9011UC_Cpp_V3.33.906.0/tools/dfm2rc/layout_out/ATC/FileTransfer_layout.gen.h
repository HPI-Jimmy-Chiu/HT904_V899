...
//  Source .dfm: ATC/FileTransfer.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for FileTransfer -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_FILETRANSFER_H
#define HT9045_GEN_LAYOUT_FILETRANSFER_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kFileTransferLayout[];
extern const int kFileTransferLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_FILETRANSFER_H
