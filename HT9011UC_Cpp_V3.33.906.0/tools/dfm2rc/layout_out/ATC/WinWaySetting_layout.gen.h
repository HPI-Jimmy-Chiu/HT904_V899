// ===========================================================================
//  ATC/WinWaySetting_layout.gen.h
...
//  Source .dfm: ATC/WinWaySetting.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for WinWaySetting -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_WINWAYSETTING_H
#define HT9045_GEN_LAYOUT_WINWAYSETTING_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kWinWaySettingLayout[];
extern const int kWinWaySettingLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_WINWAYSETTING_H
