...
//  Source .dfm: cSecurity.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cSecurity -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CSECURITY_H
#define HT9045_GEN_LAYOUT_CSECURITY_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcSecurityLayout[];
extern const int kcSecurityLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CSECURITY_H
