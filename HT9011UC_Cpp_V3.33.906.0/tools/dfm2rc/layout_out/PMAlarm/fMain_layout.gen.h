...
//  Source .dfm: PMAlarm/fMain.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for fMain -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_FMAIN_H
#define HT9045_GEN_LAYOUT_FMAIN_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kfMainLayout[];
extern const int kfMainLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_FMAIN_H
