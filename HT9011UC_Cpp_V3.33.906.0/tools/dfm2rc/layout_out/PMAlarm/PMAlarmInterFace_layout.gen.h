// ===========================================================================
//  PMAlarm/PMAlarmInterFace_layout.gen.h
...
//  Source .dfm: PMAlarm/PMAlarmInterFace.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for PMAlarmInterFace -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_PMALARMINTERFACE_H
#define HT9045_GEN_LAYOUT_PMALARMINTERFACE_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kPMAlarmInterFaceLayout[];
extern const int kPMAlarmInterFaceLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_PMALARMINTERFACE_H
