...
//  Source .dfm: ShuttleMove.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for ShuttleMove -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_SHUTTLEMOVE_H
#define HT9045_GEN_LAYOUT_SHUTTLEMOVE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kShuttleMoveLayout[];
extern const int kShuttleMoveLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_SHUTTLEMOVE_H
