// ===========================================================================
//  Interface/TesterTCP_layout.gen.h
...
//  Source .dfm: Interface/TesterTCP.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for TesterTCP -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_TESTERTCP_H
#define HT9045_GEN_LAYOUT_TESTERTCP_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kTesterTCPLayout[];
extern const int kTesterTCPLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_TESTERTCP_H
