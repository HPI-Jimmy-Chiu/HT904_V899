...
//  Source .dfm: DynamicTemp.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for DynamicTemp -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_DYNAMICTEMP_H
#define HT9045_GEN_LAYOUT_DYNAMICTEMP_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kDynamicTempLayout[];
extern const int kDynamicTempLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_DYNAMICTEMP_H
