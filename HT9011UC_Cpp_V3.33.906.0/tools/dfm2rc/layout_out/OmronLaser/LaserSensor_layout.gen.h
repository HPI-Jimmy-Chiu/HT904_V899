// ===========================================================================
//  OmronLaser/LaserSensor_layout.gen.h
...
//  Source .dfm: OmronLaser/LaserSensor.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for LaserSensor -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_LASERSENSOR_H
#define HT9045_GEN_LAYOUT_LASERSENSOR_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kLaserSensorLayout[];
extern const int kLaserSensorLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_LASERSENSOR_H
