// ===========================================================================
//  AutoClean/uCleaning_layout.gen.h
...
//  Source .dfm: AutoClean/uCleaning.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uCleaning -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_UCLEANING_H
#define HT9045_GEN_LAYOUT_UCLEANING_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuCleaningLayout[];
extern const int kuCleaningLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_UCLEANING_H
