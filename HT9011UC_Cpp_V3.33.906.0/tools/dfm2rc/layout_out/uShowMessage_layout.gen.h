...
//  Source .dfm: uShowMessage.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uShowMessage -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_USHOWMESSAGE_H
#define HT9045_GEN_LAYOUT_USHOWMESSAGE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuShowMessageLayout[];
extern const int kuShowMessageLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_USHOWMESSAGE_H
