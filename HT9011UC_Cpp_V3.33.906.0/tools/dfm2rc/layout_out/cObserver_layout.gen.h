...
//  Source .dfm: cObserver.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cObserver -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_COBSERVER_H
#define HT9045_GEN_LAYOUT_COBSERVER_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcObserverLayout[];
extern const int kcObserverLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_COBSERVER_H
