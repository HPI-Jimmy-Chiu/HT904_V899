// ===========================================================================
//  Monitor/MonitorInterface_layout.gen.h
...
//  Source .dfm: Monitor/MonitorInterface.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for MonitorInterface -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_MONITORINTERFACE_H
#define HT9045_GEN_LAYOUT_MONITORINTERFACE_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kMonitorInterfaceLayout[];
extern const int kMonitorInterfaceLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_MONITORINTERFACE_H
