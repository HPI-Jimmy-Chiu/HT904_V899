...
//  Source .dfm: HandlerSys.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for HandlerSys -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_HANDLERSYS_H
#define HT9045_GEN_LAYOUT_HANDLERSYS_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kHandlerSysLayout[];
extern const int kHandlerSysLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_HANDLERSYS_H
