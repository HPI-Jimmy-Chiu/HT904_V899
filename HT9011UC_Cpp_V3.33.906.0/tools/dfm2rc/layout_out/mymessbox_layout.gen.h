...
//  Source .dfm: mymessbox.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for mymessbox -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_MYMESSBOX_H
#define HT9045_GEN_LAYOUT_MYMESSBOX_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kmymessboxLayout[];
extern const int kmymessboxLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_MYMESSBOX_H
