...
//  Source .dfm: uMotorTest.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uMotorTest -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_UMOTORTEST_H
#define HT9045_GEN_LAYOUT_UMOTORTEST_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuMotorTestLayout[];
extern const int kuMotorTestLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_UMOTORTEST_H
