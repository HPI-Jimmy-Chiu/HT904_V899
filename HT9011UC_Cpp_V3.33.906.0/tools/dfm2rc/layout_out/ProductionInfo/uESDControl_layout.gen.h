// ===========================================================================
//  ProductionInfo/uESDControl_layout.gen.h
...
//  Source .dfm: ProductionInfo/uESDControl.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uESDControl -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_UESDCONTROL_H
#define HT9045_GEN_LAYOUT_UESDCONTROL_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuESDControlLayout[];
extern const int kuESDControlLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_UESDCONTROL_H
