...
//  Source .dfm: cBuilder.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cBuilder -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CBUILDER_H
#define HT9045_GEN_LAYOUT_CBUILDER_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcBuilderLayout[];
extern const int kcBuilderLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CBUILDER_H
