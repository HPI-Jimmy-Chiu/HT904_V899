...
//  Source .dfm: cTrayForm.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cTrayForm -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CTRAYFORM_H
#define HT9045_GEN_LAYOUT_CTRAYFORM_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcTrayFormLayout[];
extern const int kcTrayFormLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CTRAYFORM_H
