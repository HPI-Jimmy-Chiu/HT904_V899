...
//  Source .dfm: Magazine.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for Magazine -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_MAGAZINE_H
#define HT9045_GEN_LAYOUT_MAGAZINE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kMagazineLayout[];
extern const int kMagazineLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_MAGAZINE_H
