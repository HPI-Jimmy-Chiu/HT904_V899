// ===========================================================================
//  BarCode/BarcodeXML_layout.gen.h
...
//  Source .dfm: BarCode/BarcodeXML.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for BarcodeXML -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_BARCODEXML_H
#define HT9045_GEN_LAYOUT_BARCODEXML_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kBarcodeXMLLayout[];
extern const int kBarcodeXMLLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_BARCODEXML_H
