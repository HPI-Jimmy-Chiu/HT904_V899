...
//  Source .dfm: BarCode/BarCode.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for BarCode -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_BARCODE_H
#define HT9045_GEN_LAYOUT_BARCODE_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kBarCodeLayout[];
extern const int kBarCodeLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_BARCODE_H
