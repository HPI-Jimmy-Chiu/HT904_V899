...
//  Source .dfm: cTemperFrom.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cTemperFrom -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CTEMPERFROM_H
#define HT9045_GEN_LAYOUT_CTEMPERFROM_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcTemperFromLayout[];
extern const int kcTemperFromLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CTEMPERFROM_H
