// ===========================================================================
//  Mes/fVATMesFileSys_layout.gen.h
...
//  Source .dfm: Mes/fVATMesFileSys.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for fVATMesFileSys -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_FVATMESFILESYS_H
#define HT9045_GEN_LAYOUT_FVATMESFILESYS_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kfVATMesFileSysLayout[];
extern const int kfVATMesFileSysLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_FVATMESFILESYS_H
