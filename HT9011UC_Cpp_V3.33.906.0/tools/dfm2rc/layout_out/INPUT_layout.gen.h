...
//  Source .dfm: INPUT.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for INPUT -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_INPUT_H
#define HT9045_GEN_LAYOUT_INPUT_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kINPUTLayout[];
extern const int kINPUTLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_INPUT_H
