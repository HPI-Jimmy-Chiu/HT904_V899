// ===========================================================================
//  AutoTeach/InOutArmZteach_layout.gen.h
...
//  Source .dfm: AutoTeach/InOutArmZteach.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for InOutArmZteach -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_INOUTARMZTEACH_H
#define HT9045_GEN_LAYOUT_INOUTARMZTEACH_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kInOutArmZteachLayout[];
extern const int kInOutArmZteachLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_INOUTARMZTEACH_H
