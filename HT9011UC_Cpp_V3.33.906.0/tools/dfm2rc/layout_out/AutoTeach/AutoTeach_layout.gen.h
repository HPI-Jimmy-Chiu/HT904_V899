// ===========================================================================
//  AutoTeach/AutoTeach_layout.gen.h
...
//  Source .dfm: AutoTeach/AutoTeach.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for AutoTeach -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_AUTOTEACH_H
#define HT9045_GEN_LAYOUT_AUTOTEACH_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kAutoTeachLayout[];
extern const int kAutoTeachLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_AUTOTEACH_H
