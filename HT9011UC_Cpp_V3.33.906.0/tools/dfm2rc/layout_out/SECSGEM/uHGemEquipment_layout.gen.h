// ===========================================================================
//  SECSGEM/uHGemEquipment_layout.gen.h
...
//  Source .dfm: SECSGEM/uHGemEquipment.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uHGemEquipment -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_UHGEMEQUIPMENT_H
#define HT9045_GEN_LAYOUT_UHGEMEQUIPMENT_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuHGemEquipmentLayout[];
extern const int kuHGemEquipmentLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_UHGEMEQUIPMENT_H
