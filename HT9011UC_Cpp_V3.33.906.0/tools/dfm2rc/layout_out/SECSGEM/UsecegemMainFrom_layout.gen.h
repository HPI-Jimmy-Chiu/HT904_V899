// ===========================================================================
//  SECSGEM/UsecegemMainFrom_layout.gen.h
...
//  Source .dfm: SECSGEM/UsecegemMainFrom.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for UsecegemMainFrom -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_USECEGEMMAINFROM_H
#define HT9045_GEN_LAYOUT_USECEGEMMAINFROM_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kUsecegemMainFromLayout[];
extern const int kUsecegemMainFromLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_USECEGEMMAINFROM_H
