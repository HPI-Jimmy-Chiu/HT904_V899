...
//  Source .dfm: OCR.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for OCR -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_OCR_H
#define HT9045_GEN_LAYOUT_OCR_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kOCRLayout[];
extern const int kOCRLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_OCR_H
