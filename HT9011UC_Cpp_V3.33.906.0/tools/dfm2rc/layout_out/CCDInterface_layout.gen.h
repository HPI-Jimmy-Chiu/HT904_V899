...
//  Source .dfm: CCDInterface.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for CCDInterface -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CCDINTERFACE_H
#define HT9045_GEN_LAYOUT_CCDINTERFACE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kCCDInterfaceLayout[];
extern const int kCCDInterfaceLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CCDINTERFACE_H
