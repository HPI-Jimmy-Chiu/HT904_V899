// ===========================================================================
//  TempCtrl/MyTempture_layout.gen.h
...
//  Source .dfm: TempCtrl/MyTempture.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for MyTempture -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_MYTEMPTURE_H
#define HT9045_GEN_LAYOUT_MYTEMPTURE_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kMyTemptureLayout[];
extern const int kMyTemptureLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_MYTEMPTURE_H
