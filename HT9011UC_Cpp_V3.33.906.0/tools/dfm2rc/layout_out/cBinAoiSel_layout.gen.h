...
//  Source .dfm: cBinAoiSel.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cBinAoiSel -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CBINAOISEL_H
#define HT9045_GEN_LAYOUT_CBINAOISEL_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcBinAoiSelLayout[];
extern const int kcBinAoiSelLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CBINAOISEL_H
