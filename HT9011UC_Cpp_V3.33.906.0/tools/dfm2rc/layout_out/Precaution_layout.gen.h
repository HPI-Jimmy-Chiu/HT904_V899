...
//  Source .dfm: Precaution.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for Precaution -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_PRECAUTION_H
#define HT9045_GEN_LAYOUT_PRECAUTION_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kPrecautionLayout[];
extern const int kPrecautionLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_PRECAUTION_H
