...
//  Source .dfm: MR/Cassette.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for Cassette -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CASSETTE_H
#define HT9045_GEN_LAYOUT_CASSETTE_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kCassetteLayout[];
extern const int kCassetteLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CASSETTE_H
