...
//  Source .dfm: MR/RFID.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for RFID -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_RFID_H
#define HT9045_GEN_LAYOUT_RFID_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kRFIDLayout[];
extern const int kRFIDLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_RFID_H
