...
//  Source .dfm: HS_Function.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for HS_Function -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_HS_FUNCTION_H
#define HT9045_GEN_LAYOUT_HS_FUNCTION_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kHS_FunctionLayout[];
extern const int kHS_FunctionLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_HS_FUNCTION_H
