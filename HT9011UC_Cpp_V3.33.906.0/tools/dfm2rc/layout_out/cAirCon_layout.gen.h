...
//  Source .dfm: cAirCon.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cAirCon -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CAIRCON_H
#define HT9045_GEN_LAYOUT_CAIRCON_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcAirConLayout[];
extern const int kcAirConLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CAIRCON_H
