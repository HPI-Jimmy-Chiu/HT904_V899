...
//  Source .dfm: uteach.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uteach -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_UTEACH_H
#define HT9045_GEN_LAYOUT_UTEACH_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuteachLayout[];
extern const int kuteachLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_UTEACH_H
