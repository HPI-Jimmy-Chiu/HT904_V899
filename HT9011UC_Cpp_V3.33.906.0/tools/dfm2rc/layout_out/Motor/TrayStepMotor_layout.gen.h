// ===========================================================================
//  Motor/TrayStepMotor_layout.gen.h
...
//  Source .dfm: Motor/TrayStepMotor.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for TrayStepMotor -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_TRAYSTEPMOTOR_H
#define HT9045_GEN_LAYOUT_TRAYSTEPMOTOR_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kTrayStepMotorLayout[];
extern const int kTrayStepMotorLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_TRAYSTEPMOTOR_H
