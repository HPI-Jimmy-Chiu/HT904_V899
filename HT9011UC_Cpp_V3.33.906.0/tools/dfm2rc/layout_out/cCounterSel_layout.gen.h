...
//  Source .dfm: cCounterSel.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cCounterSel -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CCOUNTERSEL_H
#define HT9045_GEN_LAYOUT_CCOUNTERSEL_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcCounterSelLayout[];
extern const int kcCounterSelLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CCOUNTERSEL_H
