...
//  Source .dfm: fShowPmSOP.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for fShowPmSOP -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_FSHOWPMSOP_H
#define HT9045_GEN_LAYOUT_FSHOWPMSOP_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kfShowPmSOPLayout[];
extern const int kfShowPmSOPLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_FSHOWPMSOP_H
