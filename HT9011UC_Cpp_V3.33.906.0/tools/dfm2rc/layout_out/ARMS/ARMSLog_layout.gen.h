...
//  Source .dfm: ARMS/ARMSLog.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for ARMSLog -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_ARMSLOG_H
#define HT9045_GEN_LAYOUT_ARMSLOG_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kARMSLogLayout[];
extern const int kARMSLogLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_ARMSLOG_H
