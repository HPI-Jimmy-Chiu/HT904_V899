...
//  Source .dfm: ARMS/ARMS.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for ARMS -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_ARMS_H
#define HT9045_GEN_LAYOUT_ARMS_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kARMSLayout[];
extern const int kARMSLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_ARMS_H
