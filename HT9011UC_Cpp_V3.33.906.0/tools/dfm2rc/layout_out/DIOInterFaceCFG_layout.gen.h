...
//  Source .dfm: DIOInterFaceCFG.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for DIOInterFaceCFG -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_DIOINTERFACECFG_H
#define HT9045_GEN_LAYOUT_DIOINTERFACECFG_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kDIOInterFaceCFGLayout[];
extern const int kDIOInterFaceCFGLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_DIOINTERFACECFG_H
