...
//  Source .dfm: cTrayMapping.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cTrayMapping -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CTRAYMAPPING_H
#define HT9045_GEN_LAYOUT_CTRAYMAPPING_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcTrayMappingLayout[];
extern const int kcTrayMappingLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CTRAYMAPPING_H
