...
//  Source .dfm: cContactCT.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cContactCT -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CCONTACTCT_H
#define HT9045_GEN_LAYOUT_CCONTACTCT_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcContactCTLayout[];
extern const int kcContactCTLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CCONTACTCT_H
