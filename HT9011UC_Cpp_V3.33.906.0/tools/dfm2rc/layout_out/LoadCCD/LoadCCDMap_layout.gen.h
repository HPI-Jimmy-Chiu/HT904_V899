// ===========================================================================
//  LoadCCD/LoadCCDMap_layout.gen.h
...
//  Source .dfm: LoadCCD/LoadCCDMap.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for LoadCCDMap -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_LOADCCDMAP_H
#define HT9045_GEN_LAYOUT_LOADCCDMAP_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kLoadCCDMapLayout[];
extern const int kLoadCCDMapLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_LOADCCDMAP_H
