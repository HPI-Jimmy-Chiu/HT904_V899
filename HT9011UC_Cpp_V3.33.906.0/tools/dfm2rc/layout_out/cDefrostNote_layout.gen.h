...
//  Source .dfm: cDefrostNote.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cDefrostNote -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CDEFROSTNOTE_H
#define HT9045_GEN_LAYOUT_CDEFROSTNOTE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcDefrostNoteLayout[];
extern const int kcDefrostNoteLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CDEFROSTNOTE_H
