...
//  Source .dfm: cTowerLight.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cTowerLight -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CTOWERLIGHT_H
#define HT9045_GEN_LAYOUT_CTOWERLIGHT_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcTowerLightLayout[];
extern const int kcTowerLightLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CTOWERLIGHT_H
