...
//  Source .dfm: Password.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for Password -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_PASSWORD_H
#define HT9045_GEN_LAYOUT_PASSWORD_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kPasswordLayout[];
extern const int kPasswordLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_PASSWORD_H
