// ===========================================================================
//  RotateKit/fRotate_layout.gen.h
...
//  Source .dfm: RotateKit/fRotate.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for fRotate -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_FROTATE_H
#define HT9045_GEN_LAYOUT_FROTATE_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kfRotateLayout[];
extern const int kfRotateLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_FROTATE_H
