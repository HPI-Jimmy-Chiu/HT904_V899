...
//  Source .dfm: cTesterIF.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cTesterIF -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CTESTERIF_H
#define HT9045_GEN_LAYOUT_CTESTERIF_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcTesterIFLayout[];
extern const int kcTesterIFLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CTESTERIF_H
