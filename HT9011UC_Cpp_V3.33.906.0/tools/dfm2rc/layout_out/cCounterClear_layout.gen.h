...
//  Source .dfm: cCounterClear.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cCounterClear -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CCOUNTERCLEAR_H
#define HT9045_GEN_LAYOUT_CCOUNTERCLEAR_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcCounterClearLayout[];
extern const int kcCounterClearLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CCOUNTERCLEAR_H
