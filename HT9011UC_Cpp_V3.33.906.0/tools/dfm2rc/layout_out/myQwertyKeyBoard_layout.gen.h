...
//  Source .dfm: myQwertyKeyBoard.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for myQwertyKeyBoard -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_MYQWERTYKEYBOARD_H
#define HT9045_GEN_LAYOUT_MYQWERTYKEYBOARD_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kmyQwertyKeyBoardLayout[];
extern const int kmyQwertyKeyBoardLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_MYQWERTYKEYBOARD_H
