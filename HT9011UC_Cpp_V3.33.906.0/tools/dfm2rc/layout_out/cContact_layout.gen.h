...
//  Source .dfm: cContact.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cContact -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CCONTACT_H
#define HT9045_GEN_LAYOUT_CCONTACT_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcContactLayout[];
extern const int kcContactLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CCONTACT_H
