...
//  Source .dfm: cHotPlate.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cHotPlate -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CHOTPLATE_H
#define HT9045_GEN_LAYOUT_CHOTPLATE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcHotPlateLayout[];
extern const int kcHotPlateLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CHOTPLATE_H
