...
//  Source .dfm: fAOI.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for fAOI -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_FAOI_H
#define HT9045_GEN_LAYOUT_FAOI_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kfAOILayout[];
extern const int kfAOILayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_FAOI_H
