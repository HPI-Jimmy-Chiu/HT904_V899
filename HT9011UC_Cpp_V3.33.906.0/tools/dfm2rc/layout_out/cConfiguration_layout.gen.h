...
//  Source .dfm: cConfiguration.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cConfiguration -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CCONFIGURATION_H
#define HT9045_GEN_LAYOUT_CCONFIGURATION_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcConfigurationLayout[];
extern const int kcConfigurationLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CCONFIGURATION_H
