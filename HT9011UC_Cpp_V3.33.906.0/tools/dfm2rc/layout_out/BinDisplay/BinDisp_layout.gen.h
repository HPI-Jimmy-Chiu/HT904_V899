// ===========================================================================
//  BinDisplay/BinDisp_layout.gen.h
...
//  Source .dfm: BinDisplay/BinDisp.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for BinDisp -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_BINDISP_H
#define HT9045_GEN_LAYOUT_BINDISP_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kBinDispLayout[];
extern const int kBinDispLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_BINDISP_H
