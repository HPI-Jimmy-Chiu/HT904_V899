// ===========================================================================
//  BinDisplay/MyBinDisp_layout.gen.h
...
//  Source .dfm: BinDisplay/MyBinDisp.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for MyBinDisp -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_MYBINDISP_H
#define HT9045_GEN_LAYOUT_MYBINDISP_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kMyBinDispLayout[];
extern const int kMyBinDispLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_MYBINDISP_H
