...
//  Source .dfm: InputForm.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for InputForm -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_INPUTFORM_H
#define HT9045_GEN_LAYOUT_INPUTFORM_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kInputFormLayout[];
extern const int kInputFormLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_INPUTFORM_H
