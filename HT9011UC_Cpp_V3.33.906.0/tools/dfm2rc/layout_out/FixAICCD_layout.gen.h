...
//  Source .dfm: FixAICCD.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for FixAICCD -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_FIXAICCD_H
#define HT9045_GEN_LAYOUT_FIXAICCD_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kFixAICCDLayout[];
extern const int kFixAICCDLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_FIXAICCD_H
