...
//  Source .dfm: EJ1N/OmronEJ1N.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for OmronEJ1N -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_OMRONEJ1N_H
#define HT9045_GEN_LAYOUT_OMRONEJ1N_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kOmronEJ1NLayout[];
extern const int kOmronEJ1NLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_OMRONEJ1N_H
