...
//  Source .dfm: cTrayAssignment.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cTrayAssignment -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CTRAYASSIGNMENT_H
#define HT9045_GEN_LAYOUT_CTRAYASSIGNMENT_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcTrayAssignmentLayout[];
extern const int kcTrayAssignmentLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CTRAYASSIGNMENT_H
