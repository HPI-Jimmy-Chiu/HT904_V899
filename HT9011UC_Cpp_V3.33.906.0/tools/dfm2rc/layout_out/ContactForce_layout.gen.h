...
//  Source .dfm: ContactForce.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for ContactForce -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CONTACTFORCE_H
#define HT9045_GEN_LAYOUT_CONTACTFORCE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kContactForceLayout[];
extern const int kContactForceLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CONTACTFORCE_H
