...
//  Source .dfm: note.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for note -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_NOTE_H
#define HT9045_GEN_LAYOUT_NOTE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout knoteLayout[];
extern const int knoteLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_NOTE_H
