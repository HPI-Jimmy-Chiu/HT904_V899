...
//  Source .dfm: uRecipeDefault.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uRecipeDefault -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_URECIPEDEFAULT_H
#define HT9045_GEN_LAYOUT_URECIPEDEFAULT_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuRecipeDefaultLayout[];
extern const int kuRecipeDefaultLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_URECIPEDEFAULT_H
