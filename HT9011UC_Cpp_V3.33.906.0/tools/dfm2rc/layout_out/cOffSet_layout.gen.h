...
//  Source .dfm: cOffSet.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cOffSet -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_COFFSET_H
#define HT9045_GEN_LAYOUT_COFFSET_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcOffSetLayout[];
extern const int kcOffSetLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_COFFSET_H
