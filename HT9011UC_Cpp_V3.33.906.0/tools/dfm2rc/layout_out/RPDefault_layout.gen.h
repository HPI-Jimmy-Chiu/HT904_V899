...
//  Source .dfm: RPDefault.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for RPDefault -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_RPDEFAULT_H
#define HT9045_GEN_LAYOUT_RPDEFAULT_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kRPDefaultLayout[];
extern const int kRPDefaultLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_RPDEFAULT_H
