...
//  Source .dfm: cSortCT.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cSortCT -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CSORTCT_H
#define HT9045_GEN_LAYOUT_CSORTCT_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcSortCTLayout[];
extern const int kcSortCTLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CSORTCT_H
