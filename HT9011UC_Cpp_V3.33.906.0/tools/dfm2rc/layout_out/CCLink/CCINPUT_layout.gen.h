...
//  Source .dfm: CCLink/CCINPUT.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for CCINPUT -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CCINPUT_H
#define HT9045_GEN_LAYOUT_CCINPUT_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kCCINPUTLayout[];
extern const int kCCINPUTLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CCINPUT_H
