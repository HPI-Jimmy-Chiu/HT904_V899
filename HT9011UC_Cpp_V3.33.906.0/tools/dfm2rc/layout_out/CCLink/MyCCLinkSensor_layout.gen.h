// ===========================================================================
//  CCLink/MyCCLinkSensor_layout.gen.h
...
//  Source .dfm: CCLink/MyCCLinkSensor.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for MyCCLinkSensor -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_MYCCLINKSENSOR_H
#define HT9045_GEN_LAYOUT_MYCCLINKSENSOR_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kMyCCLinkSensorLayout[];
extern const int kMyCCLinkSensorLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_MYCCLINKSENSOR_H
