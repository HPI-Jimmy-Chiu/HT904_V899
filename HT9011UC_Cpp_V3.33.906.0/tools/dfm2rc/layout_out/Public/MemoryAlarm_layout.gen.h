// ===========================================================================
//  Public/MemoryAlarm_layout.gen.h
...
//  Source .dfm: Public/MemoryAlarm.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for MemoryAlarm -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_MEMORYALARM_H
#define HT9045_GEN_LAYOUT_MEMORYALARM_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kMemoryAlarmLayout[];
extern const int kMemoryAlarmLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_MEMORYALARM_H
