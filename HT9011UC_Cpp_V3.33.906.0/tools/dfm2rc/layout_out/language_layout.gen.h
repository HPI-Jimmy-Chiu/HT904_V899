...
//  Source .dfm: language.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for language -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_LANGUAGE_H
#define HT9045_GEN_LAYOUT_LANGUAGE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout klanguageLayout[];
extern const int klanguageLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_LANGUAGE_H
