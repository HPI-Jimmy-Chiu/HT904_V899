...
//  Source .dfm: cheksocket.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cheksocket -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CHEKSOCKET_H
#define HT9045_GEN_LAYOUT_CHEKSOCKET_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcheksocketLayout[];
extern const int kcheksocketLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CHEKSOCKET_H
