...
//  Source .dfm: cSpeed.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cSpeed -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CSPEED_H
#define HT9045_GEN_LAYOUT_CSPEED_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcSpeedLayout[];
extern const int kcSpeedLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CSPEED_H
