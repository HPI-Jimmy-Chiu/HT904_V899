// ===========================================================================
//  Automation/SCK_ART_layout.gen.h
...
//  Source .dfm: Automation/SCK_ART.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for SCK_ART -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_SCK_ART_H
#define HT9045_GEN_LAYOUT_SCK_ART_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kSCK_ARTLayout[];
extern const int kSCK_ARTLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_SCK_ART_H
