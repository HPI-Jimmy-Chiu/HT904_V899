// ===========================================================================
//  Automation/mainAT_layout.gen.h
...
//  Source .dfm: Automation/mainAT.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for mainAT -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_MAINAT_H
#define HT9045_GEN_LAYOUT_MAINAT_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kmainATLayout[];
extern const int kmainATLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_MAINAT_H
