// ===========================================================================
//  Automation/ufrmProdInfo_layout.gen.h
...
//  Source .dfm: Automation/ufrmProdInfo.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for ufrmProdInfo -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_UFRMPRODINFO_H
#define HT9045_GEN_LAYOUT_UFRMPRODINFO_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kufrmProdInfoLayout[];
extern const int kufrmProdInfoLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_UFRMPRODINFO_H
