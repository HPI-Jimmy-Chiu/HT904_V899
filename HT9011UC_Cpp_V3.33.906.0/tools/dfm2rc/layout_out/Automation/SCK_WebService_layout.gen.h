// ===========================================================================
//  Automation/SCK_WebService_layout.gen.h
...
//  Source .dfm: Automation/SCK_WebService.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for SCK_WebService -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_SCK_WEBSERVICE_H
#define HT9045_GEN_LAYOUT_SCK_WEBSERVICE_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kSCK_WebServiceLayout[];
extern const int kSCK_WebServiceLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_SCK_WEBSERVICE_H
