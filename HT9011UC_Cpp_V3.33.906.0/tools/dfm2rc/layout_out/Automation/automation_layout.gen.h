// ===========================================================================
//  Automation/automation_layout.gen.h
...
//  Source .dfm: Automation/automation.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for automation -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_AUTOMATION_H
#define HT9045_GEN_LAYOUT_AUTOMATION_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kautomationLayout[];
extern const int kautomationLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_AUTOMATION_H
