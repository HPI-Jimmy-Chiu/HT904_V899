...
//  Source .dfm: Automation/AGV.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for AGV -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_AGV_H
#define HT9045_GEN_LAYOUT_AGV_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kAGVLayout[];
extern const int kAGVLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_AGV_H
