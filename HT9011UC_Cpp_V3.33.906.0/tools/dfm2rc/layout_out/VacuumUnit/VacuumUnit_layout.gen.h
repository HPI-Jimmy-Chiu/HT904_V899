// ===========================================================================
//  VacuumUnit/VacuumUnit_layout.gen.h
...
//  Source .dfm: VacuumUnit/VacuumUnit.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for VacuumUnit -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_VACUUMUNIT_H
#define HT9045_GEN_LAYOUT_VACUUMUNIT_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kVacuumUnitLayout[];
extern const int kVacuumUnitLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_VACUUMUNIT_H
