...
//  Source .dfm: uTemp_Set.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uTemp_Set -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_UTEMP_SET_H
#define HT9045_GEN_LAYOUT_UTEMP_SET_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuTemp_SetLayout[];
extern const int kuTemp_SetLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_UTEMP_SET_H
