...
//  Source .dfm: uTechShow.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uTechShow -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_UTECHSHOW_H
#define HT9045_GEN_LAYOUT_UTECHSHOW_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuTechShowLayout[];
extern const int kuTechShowLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_UTECHSHOW_H
