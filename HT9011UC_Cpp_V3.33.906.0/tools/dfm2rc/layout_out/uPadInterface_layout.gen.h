...
//  Source .dfm: uPadInterface.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uPadInterface -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_UPADINTERFACE_H
#define HT9045_GEN_LAYOUT_UPADINTERFACE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuPadInterfaceLayout[];
extern const int kuPadInterfaceLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_UPADINTERFACE_H
