...
//  Source .dfm: AutoTemperature.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for AutoTemperature -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_AUTOTEMPERATURE_H
#define HT9045_GEN_LAYOUT_AUTOTEMPERATURE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kAutoTemperatureLayout[];
extern const int kAutoTemperatureLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_AUTOTEMPERATURE_H
