...
//  Source .dfm: uLotInfo.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uLotInfo -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_ULOTINFO_H
#define HT9045_GEN_LAYOUT_ULOTINFO_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuLotInfoLayout[];
extern const int kuLotInfoLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_ULOTINFO_H
