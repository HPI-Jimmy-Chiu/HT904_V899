...
//  Source .dfm: login.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for login -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_LOGIN_H
#define HT9045_GEN_LAYOUT_LOGIN_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kloginLayout[];
extern const int kloginLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_LOGIN_H
