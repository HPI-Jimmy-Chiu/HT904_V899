...
//  Source .dfm: cTestCategory.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cTestCategory -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CTESTCATEGORY_H
#define HT9045_GEN_LAYOUT_CTESTCATEGORY_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcTestCategoryLayout[];
extern const int kcTestCategoryLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CTESTCATEGORY_H
