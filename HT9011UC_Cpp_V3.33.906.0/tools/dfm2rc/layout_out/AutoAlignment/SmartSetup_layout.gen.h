// ===========================================================================
//  AutoAlignment/SmartSetup_layout.gen.h
...
//  Source .dfm: AutoAlignment/SmartSetup.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for SmartSetup -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_SMARTSETUP_H
#define HT9045_GEN_LAYOUT_SMARTSETUP_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kSmartSetupLayout[];
extern const int kSmartSetupLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_SMARTSETUP_H
