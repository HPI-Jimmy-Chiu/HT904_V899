// ===========================================================================
//  AutoAlignment/AutoAlignment_layout.gen.h
...
//  Source .dfm: AutoAlignment/AutoAlignment.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for AutoAlignment -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_AUTOALIGNMENT_H
#define HT9045_GEN_LAYOUT_AUTOALIGNMENT_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kAutoAlignmentLayout[];
extern const int kAutoAlignmentLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_AUTOALIGNMENT_H
