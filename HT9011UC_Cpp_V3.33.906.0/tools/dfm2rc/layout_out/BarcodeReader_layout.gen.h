...
//  Source .dfm: BarcodeReader.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for BarcodeReader -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_BARCODEREADER_H
#define HT9045_GEN_LAYOUT_BARCODEREADER_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kBarcodeReaderLayout[];
extern const int kBarcodeReaderLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_BARCODEREADER_H
