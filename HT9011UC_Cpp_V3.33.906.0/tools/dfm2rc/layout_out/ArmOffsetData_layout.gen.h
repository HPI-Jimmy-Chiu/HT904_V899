...
//  Source .dfm: ArmOffsetData.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for ArmOffsetData -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_ARMOFFSETDATA_H
#define HT9045_GEN_LAYOUT_ARMOFFSETDATA_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kArmOffsetDataLayout[];
extern const int kArmOffsetDataLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_ARMOFFSETDATA_H
