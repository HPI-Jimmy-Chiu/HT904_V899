...
//  Source .dfm: SmartDiagnostic.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for SmartDiagnostic -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_SMARTDIAGNOSTIC_H
#define HT9045_GEN_LAYOUT_SMARTDIAGNOSTIC_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kSmartDiagnosticLayout[];
extern const int kSmartDiagnosticLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_SMARTDIAGNOSTIC_H
