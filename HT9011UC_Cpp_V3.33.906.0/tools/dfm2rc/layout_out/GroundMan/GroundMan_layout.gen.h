// ===========================================================================
//  GroundMan/GroundMan_layout.gen.h
...
//  Source .dfm: GroundMan/GroundMan.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for GroundMan -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_GROUNDMAN_H
#define HT9045_GEN_LAYOUT_GROUNDMAN_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kGroundManLayout[];
extern const int kGroundManLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_GROUNDMAN_H
