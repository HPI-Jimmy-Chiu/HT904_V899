...
//  Source .dfm: QAMode.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for QAMode -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_QAMODE_H
#define HT9045_GEN_LAYOUT_QAMODE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kQAModeLayout[];
extern const int kQAModeLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_QAMODE_H
