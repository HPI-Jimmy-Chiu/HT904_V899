...
//  Source .dfm: systools.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for systools -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_SYSTOOLS_H
#define HT9045_GEN_LAYOUT_SYSTOOLS_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout ksystoolsLayout[];
extern const int ksystoolsLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_SYSTOOLS_H
