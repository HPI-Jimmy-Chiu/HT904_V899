...
//  Source .dfm: cLd_ULd.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cLd_ULd -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CLD_ULD_H
#define HT9045_GEN_LAYOUT_CLD_ULD_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcLd_ULdLayout[];
extern const int kcLd_ULdLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CLD_ULD_H
