...
//  Source .dfm: tools.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for tools -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_TOOLS_H
#define HT9045_GEN_LAYOUT_TOOLS_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout ktoolsLayout[];
extern const int ktoolsLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_TOOLS_H
