...
//  Source .dfm: uYieldMonitoring.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uYieldMonitoring -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_UYIELDMONITORING_H
#define HT9045_GEN_LAYOUT_UYIELDMONITORING_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuYieldMonitoringLayout[];
extern const int kuYieldMonitoringLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_UYIELDMONITORING_H
