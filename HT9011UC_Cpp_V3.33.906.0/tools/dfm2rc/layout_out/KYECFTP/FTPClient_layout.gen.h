// ===========================================================================
//  KYECFTP/FTPClient_layout.gen.h
...
//  Source .dfm: KYECFTP/FTPClient.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for FTPClient -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_FTPCLIENT_H
#define HT9045_GEN_LAYOUT_FTPCLIENT_H

#include "../DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kFTPClientLayout[];
extern const int kFTPClientLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_FTPCLIENT_H
