...
//  Source .dfm: cShowBinSet.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cShowBinSet -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CSHOWBINSET_H
#define HT9045_GEN_LAYOUT_CSHOWBINSET_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcShowBinSetLayout[];
extern const int kcShowBinSetLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CSHOWBINSET_H
