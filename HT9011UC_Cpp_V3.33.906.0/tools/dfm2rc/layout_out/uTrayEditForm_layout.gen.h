...
//  Source .dfm: uTrayEditForm.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for uTrayEditForm -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_UTRAYEDITFORM_H
#define HT9045_GEN_LAYOUT_UTRAYEDITFORM_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kuTrayEditFormLayout[];
extern const int kuTrayEditFormLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_UTRAYEDITFORM_H
