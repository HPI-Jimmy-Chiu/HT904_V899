...
//  Source .dfm: cStartCondition.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cStartCondition -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CSTARTCONDITION_H
#define HT9045_GEN_LAYOUT_CSTARTCONDITION_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcStartConditionLayout[];
extern const int kcStartConditionLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CSTARTCONDITION_H
