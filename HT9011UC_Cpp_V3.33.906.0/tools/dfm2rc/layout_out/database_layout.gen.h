...
//  Source .dfm: database.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for database -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_DATABASE_H
#define HT9045_GEN_LAYOUT_DATABASE_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kdatabaseLayout[];
extern const int kdatabaseLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_DATABASE_H
