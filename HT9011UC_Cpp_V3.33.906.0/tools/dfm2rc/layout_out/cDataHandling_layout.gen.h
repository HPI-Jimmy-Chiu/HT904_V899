...
//  Source .dfm: cDataHandling.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for cDataHandling -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_CDATAHANDLING_H
#define HT9045_GEN_LAYOUT_CDATAHANDLING_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kcDataHandlingLayout[];
extern const int kcDataHandlingLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_CDATAHANDLING_H
