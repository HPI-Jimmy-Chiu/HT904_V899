...
//  Source .dfm: LtcSensor.dfm (golden, cp950-decoded)
//
//  AI(W906-W7-B1c) 20260728: generated layout table for LtcSensor -- see
...
// ===========================================================================
#ifndef HT9045_GEN_LAYOUT_LTCSENSOR_H
#define HT9045_GEN_LAYOUT_LTCSENSOR_H

#include "DfmLayoutTypes.h"

namespace ht9045_layout {

extern const DfmControlLayout kLtcSensorLayout[];
extern const int kLtcSensorLayoutCount;

} // namespace ht9045_layout

#endif // HT9045_GEN_LAYOUT_LTCSENSOR_H
