// =============================================================================
//  ainarm9045_1x1_1.cpp  --  In-Arm per-site VARIANT (single-site 1x1_1)
//
//  Faithful translation of golden ainarm9045_1x1_1.cpp (2432 lines, BCB6, Big5).
//  Translator: AI(W6.2b-INARM-1x1_1) 20260626
//  Translation wave: W6.2b1x1 (simplest single-site in-arm config; sibling of the
//  already-translated geometry leaves ainarm_SearchPickPlate / ainarm_SearchPlacePlate
//  and the engine ainarm9045.cpp).
//
//  ROLE: the per-site in-arm pick/place state machines for the 1x1_1 layout.
//  The engine's dispatch ladder DoInArm_9045() routes iInArmType==e9045_1x1_1
//  here (un-gated at the integrate stage).  This file owns:
//    SetInOutArmParameter_1x1_1, GetNowSiteKitMode_1x1_1, InArmZNeedDown_1x1_1,
//    CheckXYPitch_1x1_1, MoveInArm2XYToShuttle_9045_1x1_1,
//    DoPlaceToHotPlate_9045_1x1_1, DoInArmPlaceToShuttle_9045_1x1_1,
//    DoInArm_9045_1x1_1_SuckerMap, DoInArmTryPickFromHotPlate_9045_1Pick,
//    DoInArm_9045_1x1_1, GetShuttleState_1x1_1, SetInArmHasDropToShuttle_1x1_1.
//
...
//  every cross-module symbol this family touches has an ACTIVE offline shim
//  (the ainarm2.cpp engine helpers were added ONCE to aHotPlateSubstrate.{h,cpp}).
//
//  VCL/Borland conversions: AnsiString (1-based, ::sprintf) via vclcompat;
//  __fastcall not present in this file; __FUNC__ via aArmHeader/canary_support
//  shim.  SOFT_SIMULTE is NOT defined -> the #ifdef SOFT_SIMULTE block in
//  DoInArmTryPickFromHotPlate_9045_1Pick keeps its golden #else (real) path
...
#include "ainarm9045.h"             // engine: GetInArmToShuttleOffset_9045 / InArmNeedCheckOffset / MoveInArmXYToShuttle_9045 / ...
#include "ainarm_SearchPickPlate.h" // shared HP-pick externs (GetVariableXInHotPlateData / bInArmTryPickFromHotPlateFinish / ...)
#include "ainarm_SearchPlacePlate.h"// shared HP-place externs (SearchPlateToPlace / MoveInArmXYToHotPlatePlace / DoPlaceToHPSwapData / HPPlaceLog / iPlaceHP / iTryPickHP)
...
#include "cprod.h"                  // Prod / TestIF / TestIF_File / ArmSpeed / ArmSpeed_File / LastSet / InArmOffSet
#include "cpublic.h"                // CosFunction
#include "aHotPlateSubstrate.h"     // InArmSuck/FLCarryKit/BLCarryKit/OutArmSuck + ainarm2 cursors/timers + engine shims + PickFromHPList + tRotate
#include "FormsFacade.h"            // fMain (DebugOneCycleHotPlate) offline stand-in
