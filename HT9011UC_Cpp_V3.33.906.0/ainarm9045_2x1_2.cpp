// =============================================================================
//  ainarm9045_2x1_2.cpp  --  In-Arm per-site VARIANT (2x1_2, dual-row 2x1 Site)
//
...
//  and the engine ainarm9045.cpp; close cousin of ainarm9045_1x2_2 (shares the
//  flag1_1x2_2[2] / Zteach / DoCheckAutoSiteMappingPosition substrate).
//  This file is dispatched by the engine's DoInArm_9045() / DoInArm_9045_SuckerMap()
//  ladder for iInArmType==e9045_2x1_2_13 (un-gated at the serial Integrate stage;
//  this Translate agent touches only its own .cpp/.h, never a shared file).
//
...
//  (NOTE: the variant tests enum e9045_2x1_2_13; the FN/helpers carry the golden
//   "_2x1_2" suffix -- enum/helper name asymmetry is golden, preserved verbatim.
//   There is NO GetShuttleState_2x1_2 in this golden file.)
//
//  FAITHFUL: every fn/var/cursor value, switch(Task) structure, formula,
//  fall-through and goto/label (IN_ARM_SHUTTLE_2x1_2 / IN_ARM_TRY_PICK_HOTPLATE_1X2_2
//  -- the pick-HP label keeps its golden 1X2 spelling verbatim) is transcribed
//  VERBATIM from the golden CP950.  All SM case bodies are ACTIVE -- they touch
//  MOT[]/Suck/Sensor/predicates/FormsFacade, all of which resolve over the Sim HAL
...
//
//  SUBSTRATE NEEDS: NONE NEW.  flag1_1x2_2[2] / Zteach (TfInOutArmZteach_Facade) /
//  DoCheckAutoSiteMappingPosition() / CheckClearAllHotICThenPickLoadIC() are all
//  ALREADY present in aHotPlateSubstrate.h (added at Integrate for the sibling
//  1x2_2 variant).  This file references them only; it defines none.
//
...
#include "aHotPlateSubstrate.h"     // InArmSuck/FLCarryKit/BLCarryKit/OutArmSuck/FTestSuck/BTestSuck + flag1_1x2_2 / Zteach / DoCheckAutoSiteMappingPosition / CheckClearAllHotICThenPickLoadIC + PickFromHPList + ptrInSHT(Backup)
...
#include "acatchtray_shims.h"        // InitProcessSingleMotorTask / MoveInArm2XYToWait / InShtInLF / InSHT1InLF / InSHT2InLF / OCRMoveInArm2XYToWait
#include "ainarm9045_2x4_16_shims.h"// InitInArmTryPickFromHotPlateTask100 / AdjustShuttlePlaceOrder / MyTickCount / fYieldMonitoring / iInposLed
#include "canary_support.h"         // ShowErrorMessage / ShowMyMessage / RecordProcess / LastSet / __FUNC__ / K_RETRY / Tempture_Hot / REALLY

// -----------------------------------------------------------------------------
//  SUBSTRATE FORWARD DECLARATIONS: none needed.  flag1_1x2_2 / the Zteach facade /
//  DoCheckAutoSiteMappingPosition / CheckClearAllHotICThenPickLoadIC already live
//  in the shared home aHotPlateSubstrate.h (#included above), added once at
//  Integrate for the sibling 1x2_2 variant.  AI(W6.2c-INARM-2x1_2) 20260626.
// -----------------------------------------------------------------------------
//==============================================================================
