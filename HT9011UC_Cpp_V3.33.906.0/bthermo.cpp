...
//   fDTME08.h / uTemp_Set.h / cConfiguration.h / HS_Function.h / ProductionInfo.h /
...
// -----------------------------------------------------------------------------
static const int LowBase                =0;
static const int MidBase                =1;
static const int HigBase                =2;
static const int UserOffSet             =3;
static const int SingleLimit            =4;
static const int TargetTemp             =5;                                     //Steven 20140924 : 各個加熱區獨立有自己的設定值
static const int AmbientHotLow          =6;                                     //kevin 20140918 恆溫控制 低  offset
static const int AmbientHotMid          =7;                                     //kevin 20140918 恆溫控制 中 offset
static const int InitTempOffset         =8;                                     //Steven 20141117 : 起測時溫度要補Offset
static const int TestOverTimeTempOffset =9;                                     //20160312 : 距離上次測試時間超過所設定時間要補Offset
static const int TempEditTotal          =10;                                    //kevin 20140918 恆溫控制 5->7
static const int KitLowBase             =11;                                    //JerryYang 20221003 Analog要求新增Kit三點offset
static const int KitMidBase             =12;
static const int KitHigBase             =13;
static const int KitAmbientHotLow       =14;
static const int KitAmbientHotMid       =15;
static const int SHigBase               =16;                                    //Ztex 2024.07.27 Add 6 Point Temperature Offset
...
//  unreachable anyway.
#if 0 // TODO(W7-UI G03a): golden :283-288
...
#if 0 // TODO(W7-UI G03b): golden :643-646
...
//  what an unshown Config form produces.
                    if(BTHERMO_G14_FCONFIGURATION_FSHOW)
                        Temp=OldTemp[Addr];
                    else
                        Temp=0;
                }
...
#if 0 // TODO(W7-UI G27): golden :3965
    int iATCAddr=fTemp_Set->iAddrToATC[Addr];                                   //Steven 20241112 : 變更ATC Mapping方式
#endif // TODO(W7-UI G27)
    int iATCAddr=0;                                                             //AI(W906-GA-BTHERMO) 20260807: G27 ACTIVE placeholder
...
//  dfm2rc layout string data.  Cannot compile.
//  ACTIVE DEFAULT: no SV is written and UN150Read[Addr] is left untouched for the DTME08 layout.
#if 0 // TODO(W7-UI G29): golden :4775-4776
