...
#define SpeedFordFunNotSupported    (FuncError + 123)
...
#define ServoTypeNotSupport			(FuncError + 145)//yangkai add 20140707
...
#define PDOReadOnlyObject			(FuncError + 161)
#define OpenFileSizeFailed			(FuncError + 162)
#define OpenFilePathFailed			(FuncError + 163)
#define InvalidFileName				(FuncError + 164)
...
#define CompareIntervalorPartsCalcuFail (FuncError + 312)
#define CmpIntervalorPartsExceedMax (FuncError + 313)
#define LinkObjectNotAssigned		(FuncError + 314)
#define APILogIsRunning				(FuncError + 315)
#define NoMoreLogData				(FuncError + 316)
#define BufferTooSmall				(FuncError + 317)
#define LoadNextPath				(FuncError + 318)
...
#define Warning_DataNotYetProcessed	 (Warning + 6)
...
#define Dsp_InvalidLatchChannelIsUsed		(DspError + 0x34)
#define Dsp_InvalidLtcchannelOnlyUseOne		(DspError + 0x35)
#define Dsp_InvalidSoftAxisID				(DspError + 0x36)
#define Dsp_InvalidAxisIsNotSetByLatch		(DspError + 0x37)
#define Dsp_InvalidLatchAxisIsNotLocal		(DspError + 0x38)
#define Dsp_InvalidCmpchannelOnlyUseOne		(DspError + 0x39)
#define Dsp_InvalidCmpAxisisUsedByOtherCh	(DspError + 0x3a)

#define Dsp_InvalidSetPwmChannel			(DspError + 0x3b)
#define Dsp_InvalidPwmChannelIsUsed			(DspError + 0x3c)
#define Dsp_InvalidPwmchannelOnlyUseOne		(DspError + 0x3d)

#define Dsp_MotionAPResetUnknown			(DspError + 0x3e)
#define Dsp_MotionAPResetZero				(DspError + 0x3f)
#define Dsp_MotionAPResetNormalError		(DspError + 0x40)
#define Dsp_MotionAPResetSegfault			(DspError + 0x41)
#define Dsp_MotionAPResetAbnormal			(DspError + 0x42)

#define Dsp_NotSetOscParameter				(DspError + 0x43)
#define Dsp_OscIsRunning					(DspError + 0x44)
#define Dsp_InvalidLinkObjectType			(DspError + 0x45)
// Axis Error
// ----------------------------------------------------------------------------
...
#define Dsp_GpNotReturnPausePosi		(DspGpError + 0x40)
