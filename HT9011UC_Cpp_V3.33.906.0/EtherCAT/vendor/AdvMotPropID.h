...
#define CFG_DevMotionMeasureTimeEnable	(CFG_Dev_ID + 113)
#define CFG_DevIoMeasureTimeEnable		(CFG_Dev_ID + 114)
#define CFG_DevMotionCyclicPercent		(CFG_Dev_ID + 115)
#define CFG_DevIoCyclicPercent			(CFG_Dev_ID + 116)
#define CFG_DevMotionCyclicWarnThreshold	(CFG_Dev_ID + 117)
#define CFG_DevIoCyclicWarnThreshold	(CFG_Dev_ID + 118)
#define CFG_DevSubSystemID				(CFG_Dev_ID + 119)
...
#define CFG_DevFsvEnable				(CFG_Dev_ID + 137)
#define CFG_DevFsv						(CFG_Dev_ID + 138)
#define CFG_DevFsvType					(CFG_Dev_ID + 139)
#define CFG_DevFsvAssign				(CFG_Dev_ID + 140)
...
#define PAR_AxCiA402HomeOffset			(PAR_Ax_ID + 59) //0x607C:0
#define PAR_AxCiA402HomeMode			(PAR_Ax_ID + 60) //0x6098:0
#define PAR_AxCiA402HomeVelHigh			(PAR_Ax_ID + 61) //0x6099:1
#define PAR_AxCiA402HomeVelLow			(PAR_Ax_ID + 62) //0x6099:2
#define PAR_AxCiA402HomeAcc				(PAR_Ax_ID + 63) //0x609A:0

#define PAR_AxMPGCounterValue			(PAR_Ax_ID + 64)
#define PAR_AxPosTorqueLmt				(PAR_Ax_ID + 65)
#define PAR_AxNegTorqueLmt				(PAR_Ax_ID + 66)
///////////////////////////////////////////////////////////////////////////////
// Axis Config
///////////////////////////////////////////////////////////////////////////////
...
#define CFG_AxBacklashDistance			(CFG_Ax_ID + 93)  
...
#define CFG_AxFeedbackSource			(CFG_Ax_ID + 158)
...
#define CFG_AxPulseInDirReverse			(CFG_Ax_ID + 264)
#define CFG_AxOffsetDistance			(CFG_Ax_ID + 265)
#define CFG_AxPhyPosition				(CFG_Ax_ID + 266)
#define CFG_AxAliasID					(CFG_Ax_ID + 267)
#define CFG_AxSubNumber					(CFG_Ax_ID + 268)
#define CFG_AxType						(CFG_Ax_ID + 269)
#define CFG_AxMPGCounterSrc				(CFG_Ax_ID + 270)
#define CFG_Ax2DCompensateTableEnable	(CFG_Ax_ID + 271)
#define CFG_AxZAxisCompensateTableEnable	(CFG_Ax_ID + 272)
#define CFG_AxFsvEnable					(CFG_Ax_ID + 273)
#define CFG_AxFsv						(CFG_Ax_ID + 274)
#define CFG_AxFsvType					(CFG_Ax_ID + 275)
#define CFG_AxFsvAssign					(CFG_Ax_ID + 276)
#define CFG_AxHomeResetMode				(CFG_Ax_ID + 277)

#define CFG_AxCompensateCmdFilterMode	(CFG_Ax_ID + 280)
#define CFG_AxCompensateCmdFilterFactor	(CFG_Ax_ID + 281)
#define CFG_AxCompensatePluse			(CFG_Ax_ID + 282)
#define CFG_AxAddonAxid					(CFG_Ax_ID + 283)
#define CFG_AxRemoveAddonAxid			(CFG_Ax_ID + 284)
/************************************************************************/
/* Add for EtherCAT                                                     */
/************************************************************************/
...
#define CFG_CH_DaqAoStartupValue	    CFG_CH_ID + 9
...
#define CFG_CH_DaqAiSamplingRate		CFG_CH_ID + 16
#define CFG_CH_DaqAiFilter				CFG_CH_ID + 17
#define CFG_CH_DaqAiBurnOutValue		CFG_CH_ID + 18
#define CFG_CH_DaqAiBurnOutEnable		CFG_CH_ID + 19
#define CFG_CH_DaqAiCJCOffset			CFG_CH_ID + 20
#define CFG_CH_DaqAoStartupEnable	    CFG_CH_ID + 21
#define CFG_CH_DaqAoSlewRateEnable	    CFG_CH_ID + 22
#define CFG_CH_DaqAoEnable				CFG_CH_ID + 23
#define CFG_CH_DaqAoSlewRate		    CFG_CH_ID + 24
#define CFG_CH_DaqDiLogic				CFG_CH_ID + 25
#define CFG_CH_DaqDiFilter				CFG_CH_ID + 26
#define CFG_CH_DaqDiAssignSlaveID		CFG_CH_ID + 27
#define CFG_CH_DaqDiAssignPDOIndex		CFG_CH_ID + 28
#define CFG_CH_DaqDiAssignPDOSubIndex	CFG_CH_ID + 29
#define CFG_CH_DaqDoAssignSlaveID		CFG_CH_ID + 30
#define CFG_CH_DaqDoAssignPDOIndex		CFG_CH_ID + 31
#define CFG_CH_DaqDoAssignPDOSubIndex	CFG_CH_ID + 32
#define CFG_CH_DaqAiAssignSlaveID		CFG_CH_ID + 33
#define CFG_CH_DaqAiAssignPDOIndex		CFG_CH_ID + 34
#define CFG_CH_DaqAiAssignPDOSubIndex	CFG_CH_ID + 35
#define CFG_CH_DaqAoAssignSlaveID		CFG_CH_ID + 36
#define CFG_CH_DaqAoAssignPDOIndex		CFG_CH_ID + 37
#define CFG_CH_DaqAoAssignPDOSubIndex	CFG_CH_ID + 38
#define CFG_CH_DaqAiUpperBound			CFG_CH_ID + 39
#define CFG_CH_DaqAiLowerBound			CFG_CH_ID + 40
#define CFG_CH_DaqAiResolution			CFG_CH_ID + 41
#define CFG_CH_DaqAiTransType			CFG_CH_ID + 42
#define CFG_CH_DaqAoUpperBound			CFG_CH_ID + 43
#define CFG_CH_DaqAoLowerBound			CFG_CH_ID + 44
#define CFG_CH_DaqAoResolution			CFG_CH_ID + 45
#define CFG_CH_DaqAoTransType			CFG_CH_ID + 46
#define CFG_CH_DaqDoFsv					CFG_CH_ID + 47
#define CFG_CH_DaqAoFsvEnable		    CFG_CH_ID + 48
#define CFG_CH_DaqDiFilterEnable		CFG_CH_ID + 49
...
#define CFG_CH_DaqDiEmgEnable			CFG_CH_ID + 83
#define CFG_CH_DaqDiEmgLogic			CFG_CH_ID + 84
...
#define CFG_CH_DaqCntPulseInDirReverse	CFG_CH_ID + 101
#define CFG_CH_DaqCntPulseInMaxFreq		CFG_CH_ID + 102
#define CFG_CH_DaqCntPulseInLogic		CFG_CH_ID + 103
#define CFG_CH_DaqCntPulseInFilter		CFG_CH_ID + 104
...
#define CFG_CH_DaqCntLatchFilter		CFG_CH_ID + 124
#define CFG_CH_DaqCntLatchPinSelect		CFG_CH_ID + 125
...
#define CFG_CH_DaqSWCmpDeviation        CFG_CH_ID + 210
#define CFG_CH_DaqSWCmpDoEnable         CFG_CH_ID + 211
#define CFG_CH_DaqSWCmpDoOutputMode     CFG_CH_ID + 212 // Toogle / Pulse
#define CFG_CH_DaqSWCmpDoLogic          CFG_CH_ID + 213 // High / Low
#define CFG_CH_DaqSWCmpDoPulseWidth     CFG_CH_ID + 214 // unit: us
#define CFG_CH_DaqSWCmpDoDelay          CFG_CH_ID + 215 // unit: us
#define CFG_CH_DaqSWCmpMethod           CFG_CH_ID + 216
//////////////////////////////////////////////////////////////////////////
...
#define CFG_GpPathDoPauseReact		 (CFG_Gp_ID + 9)
...
#define CFG_GpFsvEnable				(CFG_Gp_ID + 24)
#define CFG_GpFsv					(CFG_Gp_ID + 25)
#define CFG_GpFsvType				(CFG_Gp_ID + 26)
#define CFG_GpFsvAssign				(CFG_Gp_ID + 27)

#define  CFG_GpLineAxidCount		(CFG_Gp_ID + 45)
