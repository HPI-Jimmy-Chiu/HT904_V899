...
#define     DEV_FUNC_CMP							0x2000		//delta
#define     DEV_FUNC_LTC							0x4000
#define     DEV_FUNC_ETHERCAT						0x8000
/*
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
*/
#define     AX_ALM_EN               				0x01
#define     AX_ALM_LOGIC            				0x02
#define     AX_ALM_REACT            				0x04
#define     AX_ALM_COMM_ERR_EN      				0x08
/*
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
*/
#define		AX_PVT_EN								0x01

/*
+-----------------------------------------------------------------------------+
| ********************** Axis Cmd Filter Map Define ************************* |
+-----------------------------------------------------------------------------+
*/
#define     AX_CMD_FILTER_EN						0x01

/*
+-----------------------------------------------------------------------------+
| ******************** Axis RingCounter Map Define ************************** |
+-----------------------------------------------------------------------------+
*/
#define     AX_COUNTER_MAX							0x01
#define     AX_COUNTER_MIN							0x02
#define     AX_OVERFLOW_MODE						0x04
...
+-----------------------------------------------------------------------------+
*/
#define     LINK_AX									0x001
#define     LINK_COUNTER							0x002
/*
+-----------------------------------------------------------------------------+
+-----------------------------------------------------------------------------+
*/
...
#define		I_PULSE_GATE 							5
#define		I_PULSE_UP	 							6
/*
+-----------------------------------------------------------------------------+
| **************** Pulse In Logic / Direction Reverse Define **************** |
+-----------------------------------------------------------------------------+
*/
#define		NO_INV_DIR 								0
#define		INV_DIR 								1
...
#define     STA_AX_EXT_JOG_READY					15
/*
+-----------------------------------------------------------------------------+
...
#define     STA_GP_EXT_JOG							9      //JOG mode  [7/11/2014 kai.yang]
#define     STA_GP_EXT_MPG							10     //mpg mode  [7/11/2014 kai.yang]
#define     STA_GP_EXT_JOG_MOVING					11     //JOG moving[7/11/2014 kai.yang]
...
#define		CustomerCia402HomeMode					63 // #37316 Reserve negative 37 modes 100-37
#define     CiA402_MODE0							100
...
#define		EVT_DEV_RECOVERY_FAIL					0x400
#define		EVT_DEV_IO_RECOVERY_FAIL				0x800
...
#define		EVT_DEV_LTC_CH0							(0x1<<0)
#define		EVT_DEV_LTC_CH1							(0x1<<1)
#define		EVT_DEV_LTC_CH2							(0x1<<2)
#define		EVT_DEV_LTC_CH3							(0x1<<3)
#define		EVT_DEV_LTC_CH4							(0x1<<4)
#define		EVT_DEV_LTC_CH5							(0x1<<5)
#define		EVT_DEV_LTC_CH6							(0x1<<6)
#define		EVT_DEV_LTC_CH7							(0x1<<7)
#define		EVT_DEV_LTC_CH8							(0x1<<8)
#define		EVT_DEV_LTC_CH9							(0x1<<9)
#define		EVT_DEV_LTC_CH10						(0x1<<10)
#define		EVT_DEV_LTC_CH11						(0x1<<11)
#define		EVT_DEV_LTC_CH12						(0x1<<12)
#define		EVT_DEV_LTC_CH13						(0x1<<13)
#define		EVT_DEV_LTC_CH14						(0x1<<14)
#define		EVT_DEV_LTC_CH15						(0x1<<15)
 
#define		EVT_DEV_CMP_CH0							(0x1<<16)
#define		EVT_DEV_CMP_CH1							(0x1<<17)
#define		EVT_DEV_CMP_CH2							(0x1<<18)
#define		EVT_DEV_CMP_CH3							(0x1<<19)
#define		EVT_DEV_CMP_CH4							(0x1<<20)
#define		EVT_DEV_CMP_CH5							(0x1<<21)
#define		EVT_DEV_CMP_CH6							(0x1<<22)
#define		EVT_DEV_CMP_CH7							(0x1<<23)
#define		EVT_DEV_CMP_CH8							(0x1<<24)
#define		EVT_DEV_CMP_CH9							(0x1<<25)
#define		EVT_DEV_CMP_CH10						(0x1<<26)
#define		EVT_DEV_CMP_CH11						(0x1<<27)
#define		EVT_DEV_CMP_CH12						(0x1<<28)
#define		EVT_DEV_CMP_CH13						(0x1<<29)
#define		EVT_DEV_CMP_CH14						(0x1<<30)
#define		EVT_DEV_CMP_CH15						(0x1<<31)

#define     EVT_GP_MOTION_DONE						0x02
#define		EVT_GP_ERROR							0x08			// v1294
#define		EVT_GP_VH_START							0x10			// [2012.5.21]
#define		EVT_GP_VH_END							0x20			// [2012.5.21]
...
#define     Abs3DHelixCW							25  
#define     Rel3DHelixCW							26
#define     Abs3DHelixCCW							27
#define     Rel3DHelixCCW							28
...
#define     Abs4DHelixCW							30  //add by zhaocui.deng 20130402
#define     Rel4DHelixCW							31
#define     Abs4DHelixCCW							32
#define     Rel4DHelixCCW							33
#define     Abs5DHelixCW							34  
#define     Rel5DHelixCW							35
#define     Abs5DHelixCCW							36
#define     Rel5DHelixCCW							37
#define     Abs6DHelixCW							38  
#define     Rel6DHelixCW							39
#define     Abs6DHelixCCW							40
#define     Rel6DHelixCCW							41
#define     Abs7DHelixCW							42  
#define     Rel7DHelixCW							43
#define     Abs7DHelixCCW							44
#define     Rel7DHelixCCW							45
#define     Abs8DHelixCW							46  
#define     Rel8DHelixCW							47
#define     Abs8DHelixCCW							48
#define     Rel8DHelixCCW							49
...
#define     Abs3DHelixCWAngle						58  
#define     Rel3DHelixCWAngle						59
#define     Abs3DHelixCCWAngle						60
#define     Rel3DHelixCCWAngle						61
#define     Abs4DHelixCWAngle						62  
#define     Rel4DHelixCWAngle						63
#define     Abs4DHelixCCWAngle						64
#define     Rel4DHelixCCWAngle						65
#define     Abs5DHelixCWAngle						66  
#define     Rel5DHelixCWAngle						67
#define     Abs5DHelixCCWAngle						68
#define     Rel5DHelixCCWAngle						69
#define     Abs6DHelixCWAngle						70 
#define     Rel6DHelixCWAngle						71
#define     Abs6DHelixCCWAngle						72
#define     Rel6DHelixCCWAngle						73
#define     Abs7DHelixCWAngle						74  
#define     Rel7DHelixCWAngle						75
#define     Abs7DHelixCCWAngle						76
#define     Rel7DHelixCCWAngle						77
#define     Abs8DHelixCWAngle						78  
#define     Rel8DHelixCWAngle						79
#define     Abs8DHelixCCWAngle						80
#define     Rel8DHelixCCWAngle						81
...
#define		Abs3DHelixCW_3P							93  
#define     Rel3DHelixCW_3P							94
#define     Abs3DHelixCCW_3P						95
#define     Rel3DHelixCCW_3P						96
#define     Abs4DHelixCW_3P							97
#define     Rel4DHelixCW_3P							98
#define     Abs4DHelixCCW_3P						99
#define     Rel4DHelixCCW_3P						100
#define     Abs5DHelixCW_3P							101  
#define     Rel5DHelixCW_3P							102
#define     Abs5DHelixCCW_3P						103
#define     Rel5DHelixCCW_3P						104
#define     Abs6DHelixCW_3P							105 
#define     Rel6DHelixCW_3P							106
#define     Abs6DHelixCCW_3P						107
#define     Rel6DHelixCCW_3P						108
#define     Abs7DHelixCW_3P							109
#define     Rel7DHelixCW_3P							110
#define     Abs7DHelixCCW_3P						111
#define     Rel7DHelixCCW_3P						112
#define     Abs8DHelixCW_3P							113  
#define     Rel8DHelixCW_3P							114
#define     Abs8DHelixCCW_3P						115
#define     Rel8DHelixCCW_3P						116
...
#define		WaitforSubDeviceDI						134
#define		WaitforAxDI								135
#define		DevDoControl							136
#define		SlaveDoControl							137
#define		SubDeviceDoControl						137
#define		AbsPointR								138
#define		RelPointR								139
#define		ENRL									140
#define		DISRL									141
#define		Abs2DCLineR								142
#define		Rel2DCLineR								143
#define		IF										144
#define		ELSEIF									145
#define		ELSE									146
#define		WHILE									147
...
#define	    Abs3DLineArcCW							152
#define	    Rel3DLineArcCW							153
#define	    Abs3DLineArcCCW							154
#define	    Rel3DLineArcCCW							155

#define RemainingTime 1
#define RemainingDistance  2
#define SameTimeCompletion  3
#define CompletedTime  4
#define CompletedDistance 5
#define StaggeredTimeCompletion 6
#define StaggeredDistanceCompletion 7
#define DistancetoTarget    8
#define CompareDI            9
#define CompareDO            10
#define CompareAI            11
#define CompareAO            12
#define ComparePDO           13
#define CompareMotionIO      14
#define ComparePosition   15
#define CompareVelocity   16
#define CompareTorque     17
/*
+-----------------------------------------------------------------------------+
...
#define		CFG_DAQ_AI_PT100_385_NEG_200C_TO_420C	0x0000010E
...
#define		CFG_DAQ_AI_N_NEG_270C_TO_1300C			0x00000207
#define		CFG_DAQ_AI_R_200C_TO_1300C				0x00000208
/*
+-----------------------------------------------------------------------------+
| *********************AO Range Map * |
+-----------------------------------------------------------------------------+
...
/*
+ ---------------------------------------------------------------------------- - +
| ******************** OscType Define ****************************** |  //  [9/14/2011 dan.yang]
+---------------------------------------------------------------------------- - +
*/
#define     OSC_TYPE_AXID							0
#define     OSC_TYPE_DIN							1
#define     OSC_TYPE_DOUT							2
#define     OSC_TYPE_AIN							3
#define     OSC_TYPE_AOUT							4
#define     OSC_TYPE_ETHERCAT						5
#define     OSC_CHAN_NUM                            8
...
#ifndef _DAQ_DATA_TYPE
#define _DAQ_DATA_TYPE
typedef enum
{
	RAW_DATA = 0,
	SCALED_DATA = 1
...
#ifndef _DAQ_TRANS_TYPE
#define _DAQ_TRANS_TYPE
typedef enum
{
	TRANSTYPE_UNKNOWN = -1,
...
#ifndef _ECAT_ID_TYPE
#define _ECAT_ID_TYPE
typedef enum
{
	SUBDEVICE_ID = 0,
	SUBDEVICE_POS = 1
...
#ifndef _ADV_PORT_TYPE
#define _ADV_PORT_TYPE
typedef enum
{
	ADV_PORT_DO = 0,
	ADV_PORT_DI,
...
typedef struct _OSCPRM
{
	...
	U32 TrigMode;
	U32 TimeWidth;
}OSC_PROFILE_PRM, *POSC_PROFILE_PRM;
#endif
...
typedef struct _PATH_DIWAIT_PRM
{
	U32 MoveMode;
...
typedef struct _PATH_AXWAIT_PRM
{
	U32 AxID;
	U32 CmpMethod;
	F64 CmpValue;
...
#ifndef _PATH_VAR_PRM
#define _PATH_VAR_PRM
typedef struct _PATH_VAR_PRM
{
	U32 VarID;
	U32 CmpMethod;
	F64 CmpValue;
	F64 ValueRange;
}PATH_VAR_PRM, *PPATH_VAR_PRM;
#endif

#ifndef _PATH_OPERATOR_PRM
#define _PATH_OPERATOR_PRM
typedef struct _PATH_OPERATOR_PRM
{
	U32 VarID;
	U32 Operator;
	I32 Value;
}PATH_OPERATOR_PRM, *PPATH_OPERATOR_PRM;
#endif
...
typedef struct _DEV_EVENT_FUNC_POINT
{
	...
	ADV_USER_CALLBACK_FUNC Ax_GearIn;
	ADV_USER_CALLBACK_FUNC Gp_Motion_Done;
	ADV_USER_CALLBACK_FUNC Gp_VHStart;
	ADV_USER_CALLBACK_FUNC Gp_VHEnd;

	ADV_USER_CALLBACK_FUNC Dev_Disconnect;
	ADV_USER_CALLBACK_FUNC Dev_IO_Disconnect;
	ADV_USER_CALLBACK_FUNC Dev_Mode_Change;
	ADV_USER_CALLBACK_FUNC Dev_IO_Mode_Change;
	ADV_USER_CALLBACK_FUNC Dev_Lost_Frame;
	ADV_USER_CALLBACK_FUNC Dev_IO_Lost_Frame;
	ADV_USER_CALLBACK_FUNC Dev_Lost_Frame_Warn;
	ADV_USER_CALLBACK_FUNC Dev_IO_Lost_Frame_Warn;
	ADV_USER_CALLBACK_FUNC Dev_Comm_Recovery;
	ADV_USER_CALLBACK_FUNC Dev_IO_Comm_Recovery;
...
#ifndef _BUFFER_STATUS
#define _BUFFER_STATUS
typedef struct  _BUFFER_STATUS
{
	U32 CurIndex;
	U32 RemainCount;
	U32 FreeSpaceCount;
}BUFFER_STATUS, *PBUFFER_STATUS;
#endif
#pragma pack(pop) 