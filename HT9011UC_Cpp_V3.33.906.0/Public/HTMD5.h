 ...
 * Provenance: HT9011UC_Code_V3.33.906.0_20260618/Public/HTMD5.h
 * Changes from BCB6 original:
 *   - Replaced #include <vcl.h> with #include "vclcompat/vcl_compat.h"
 *     (brings in AnsiString, TStrings/TStringList, FileExists, DirectoryExists)
 *   - All other declarations are preserved verbatim.
 * ---------------------------------------------------------------------------*/
