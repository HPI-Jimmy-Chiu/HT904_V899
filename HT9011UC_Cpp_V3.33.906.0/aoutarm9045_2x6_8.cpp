// =============================================================================
//  aoutarm9045_2x6_8.cpp  --  Out-Arm per-site VARIANT (2x6_8, two-row 6-col 12-pick)
//
//  Faithful translation of golden aoutarm9045_2x6_8.cpp (2051 lines, BCB6, Big5/cp950).
//  Translator: AI(W6.2c-OUT-2x6_8) 20260627
//  Translation wave: W6.2c-OUT (out-arm per-site-config variant: 2x6_8).
//
//  ROLE: the per-site out-arm shuttle-pick / place-to-auto state machines for the
//  2x6_8 layout (12-site 2x6).  This file owns (golden names VERBATIM):
//    GetNowShuttleMode_2x6_8, OutArmZNeedDown_2x6_8, CheckOutArmXYPitch_2x6_8,
//    MoveOutArmToShuttleIncludeZ_9045_2x6_8, DoPickFromShuttle_9045_2x6_8,
//    DoOutArm_9045_2x6_8.
//
//  ENGINE DISPATCH (LIVE variant): the out-arm engine aoutarm9045.cpp routes
//  iInArmType==e9045_2x6_8 -> DoOutArm_9045_2x6_8() and
//  DoPickFromShuttle_9045_2x6_8(int).  The file layout suffix == the callee suffix
//  (ENUM->CALLEE map: 2x6_8 -> 2x6_8).
//
...
//  2050->2100, 3010-related, 3100->3300, 3300->3301, 3301->3500) are preserved
//  EXACTLY.
//
//  NOTE (signature irregularities preserved VERBATIM):
//    * The three pure helpers carry the _2x6_8 suffix WITHOUT the _9045_ infix
//      (GetNowShuttleMode_2x6_8 / OutArmZNeedDown_2x6_8 / CheckOutArmXYPitch_2x6_8)
//      and each takes an EXTRA iKit parameter beyond the sibling-layout norm
//      (GetNowShuttleMode_2x6_8(int iSht, int iKit) / OutArmZNeedDown_2x6_8(int
//      iSht, int iKit) / CheckOutArmXYPitch_2x6_8(int*,int*,int,int,int,int)).
//    * MoveOutArmToShuttleIncludeZ_9045_2x6_8 takes an EXTRA iKit parameter
//      (golden .cpp def names it `iKit`, .h declares it `iWhichKit`).
//
//  e2x6Mode special-mode enum (e2x6Standard..e2x6ModeTotal incl. e2x6CloseCenter2x4
//  /e2x6CloseCenter2x4Step2/e2x6CloseCenter2x41By1/e2x6Run2x4/e2x6Run2x4Step2) is
//  the FILE-LOCAL enum owned by ainarm9045_2x6_8.h -- included BEFORE
//  aHotPlateSubstrate.h so the substrate's bare `enum { e2x6OneByOne = 2 }`
//  placeholder (guarded by #ifndef ainarm9045_2x6_8H) is skipped and the full
//  enum is in scope.  iCloseSiteStep_2x6 / iCloseSiteModeFor2x6 likewise come from
//  ainarm9045_2x6_8.h.  iCloseSiteModeFor2x8 + e2x8CloseEven1By1/e2x8CloseOdd come
//  from aHotPlateSubstrate.h / MachineType.h.
//
...
//    golden: MachineDefine.h ; aoutarm9045_2x6_8.h ; aArmHeader.h ; MyKitSuck.h ;
...
#include "ainarm9045_2x6_8.h"      // FULL enum e2x6Mode + iCloseSiteStep_2x6 / iCloseSiteModeFor2x6 (included BEFORE aHotPlateSubstrate.h to skip its bare e2x6OneByOne placeholder)
...
#include "aHotPlateSubstrate.h"    // OutArmSuck/FRCarryKit/BRCarryKit + DoOutArmPlaceToAuto_9045 / DoOutArmAfterPlaceToAuto / DoOutArmAdditionalFunction / InitPlaceToAutoTask / SetMotorSpeed / iCloseSiteModeFor2x8
...
#include "acarry_shims.h"          // MoveOutArmToAutoSafe / MoveOutArmXY_ToShuttleAlarmArea / NULL_IC / iCloseSiteStep_2x8
...
// -----------------------------------------------------------------------------
#ifndef AOUTARM9045_2X6_8_ENGINE_FWD
#define AOUTARM9045_2X6_8_ENGINE_FWD
...
#endif // AOUTARM9045_2X6_8_ENGINE_FWD

// -----------------------------------------------------------------------------
//  fFixAICCD -- VCL form TfFixAICCD* (golden FixAICCD.h:152 extern PACKAGE
//  TfFixAICCD *fFixAICCD; method OutArmCycleCounterUpdate()).  FixAICCD.cpp out of
//  scope; forward-declared behind a guard with the single method this TU calls so
//  the 二次解料 AI CCD branches (case iOUTARM_SUCK + case 2000 K_SKIP path)
//  compile.  Type matches the offline single-method mirror in aoutarm_shims.cpp
//  (where the storage `TfFixAICCD *fFixAICCD = 0;` and the no-op method body
...
//  Ver : 2003_07
//  (golden aoutarm9045_2x6_8.cpp:37)
//==============================================================================
...
//==============================================================================
// (golden aoutarm9045_2x6_8.cpp:322)
//==============================================================================
...
//------------------------------------------------------------------------------
// (golden aoutarm9045_2x6_8.cpp:476)
//------------------------------------------------------------------------------
...
//==============================================================================
// (golden aoutarm9045_2x6_8.cpp:779)
//==============================================================================
...
//  Ver : 2003_07
//  (golden aoutarm9045_2x6_8.cpp:856)
//==============================================================================
...
//==============================================================================
// (golden aoutarm9045_2x6_8.cpp:1163)
//==============================================================================
