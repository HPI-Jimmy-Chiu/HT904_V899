// =============================================================================
//  ATC/ATCSystem.cpp  --  ATC_COMMAND / HT_ATC / ATCSystem / ATC60System bodies.
//
//  Faithful translation of golden ATC/ATCSystem.cpp (2126 lines, BCB6,
//  Big5/cp950).
//  Translator: AI(W906-PT-W3) 20260807
//  Translation wave: W906-PT-W3, group "atcsystem".  See ATCSystem.h's own
//  banner for the unit's role; this file is its bodies.
//
//  WAVE SCOPE -- ACTIVE vs satisfied-by-shim (every golden top-level function
//  definition, with golden line numbers):
//   ACTIVE (faithful, verbatim -- ALL 44 golden function definitions):
//     ATC_COMMAND::ATC_COMMAND         golden :13-20
//     HT_ATC::HT_ATC                   golden :22-103
//     HT_ATC::~HT_ATC                  golden :105-124
//     ATCSystem::SetPIDParameter       golden :127-130
//     HT_ATC::SetPID                   golden :133-146
//     HT_ATC::Connect                  golden :148-152
//     HT_ATC::Disconnect               golden :154-158
//     HT_ATC::IsConnect                golden :160-163
//     HT_ATC::ClearHistory             golden :165-170
//     HT_ATC::PushHistoryString(string)        golden :172-179
//     HT_ATC::PushHistoryString(string,DATA)   golden :181-195
//     HT_ATC::PopHistoryString         golden :197-211
//     HT_ATC::SendCommand(DATA)        golden :213-217
//     HT_ATC::SendCommand(string)      golden :219-223
//     HT_ATC::ClearReadData            golden :226-231
//     HT_ATC::PushReadData             golden :233-238
//     HT_ATC::PopReadData              golden :240-255
//     HT_ATC::InitialSocket            golden :257-260
//     HT_ATC::AdapterData              golden :262-610
//     HT_ATC::IsCommandString          golden :612-626
//     HT_ATC::SetUse                   golden :629-641
//     HT_ATC::SetTargetTemperature     golden :643-652
//     HT_ATC::SetTargetOffsetTemperature golden :654-659
//     HT_ATC::LotStart                 golden :661-666
//     HT_ATC::LotEnd                   golden :668-673
//     HT_ATC::SetTargetChillerTemperature golden :675-680
//     HT_ATC::CheckConnectState        golden :682-687
//     HT_ATC::SetHandlerNowArm         golden :689-694
//     HT_ATC_TCPIP_WATCH               golden :697-784
//     ATCSystem::~ATCSystem            golden :787-797
//     ATCSystem::Initial               golden :799-802
//     ATCSystem::Size                  golden :804-807
//     ATCSystem::AddChannel            golden :809-813
//     ATCSystem::DeleteChannel         golden :815-824
//     ATCSystem::SetChannelSocket      golden :826-833
//     ATCSystem::IsConnect             golden :835-841
//     ATCSystem::Connect               golden :843-853
//     ATCSystem::Disconnect            golden :855-862
//     ATCSystem::SendCommand(DATA)     golden :864-870
//     ATCSystem::SendCommand(string)   golden :872-878
//     ATCSystem::ClearHistory          golden :880-887
//     ATCSystem::PopHistoryString      golden :889-895
//     ATCSystem::ClearData             golden :897-904
//     ATCSystem::PopData               golden :906-912
//     ATCSystem::SetOnLine             golden :914-942
//     ATCSystem::SetChannelUse         golden :945-954
//     ATCSystem::SetWorkTemperature    golden :956-963
//     ATCSystem::CheckTemperatureReady golden :965-975
//     ATCSystem::GetNowTemperature     golden :977-994
//     ATCSystem::GetAllNowTemperature  golden :996-1000
//     ATCSystem::SendTestStart         golden :1016-1026
//     ATCSystem::SendTestEnd           golden :1028-1038
//     ATCSystem::SetOffsetTemperature  golden :1041-1047
//     ATCSystem::SetRunATC             golden :1049-1052
//     ATCSystem::SetStopATC            golden :1054-1058
//     ATCSystem::LotStart              golden :1060-1063
//     ATCSystem::LotEnd                golden :1065-1068
//     ATCSystem::SetChillerTemperature golden :1070-1074
//     ATCSystem::SetATCChillerSwitchOpen  golden :1076-1082
//     ATCSystem::SetATCChillerSwitchClose golden :1084-1090
//     ATCSystem::SetATCCloseMessage    golden :1092-1098
//     ATCSystem::SetTemperaturePLimit  golden :1101-1109
//     ATCSystem::GetNowWorkTemperature golden :1111-1118
//     ATCSystem::GetNowSiteOnOff       golden :1120-1135
//     ATCSystem::GetNowChillerTemperature golden :1137-1144
//     ATCSystem::GetConnectState       golden :1146-1153
//     ATCSystem::SetNowArm             golden :1155-1159
//     ATC60System::NewSocket           golden :1164-1180
//     ATC60System::ATC60System         golden :1182-1211
//     ATC60System::~ATC60System        golden :1213-1228
//     ATC60System::ATCResetParm        golden :1230-1248
//     ATC60System::SendCommand         golden :1251-1310
//     ATC60System::DoCommmand          golden :1312-1435
//     ATC60System::ClientSocket1Connect golden :1437-1447
//     ATC60System::ClientSocket1Disconnect golden :1449-1454
//     ATC60System::clientsocketRead    golden :1456-1468
//     ATC60System::ClientSocket1Error  golden :1470-1477
//     CheckStrIsNum (free fn)          golden :1479-1490
//     ATC60System::GetATCTemperature   golden :1492-1508
//     ATC60System::SetCommand          golden :1510-1547
//     ATC60System::CheckCommand        golden :1549-1567
//     ATC60System::ReSendCommand       golden :1569-1611
//     ATC60System::GetRealTemp         golden :1613-1619
//     ATC60System::LoadRecipe          golden :1621-1641
//     ATC60System::SetTargetTemperature golden :1643-1662
//     ATC60System::SetChannelUse       golden :1664-1683
//     ATC60System::SetTargetOffsetTemperature golden :1685-1716
//     ATC60System::SetATCRun           golden :1718-1739
//     ATC60System::SetHandlerNowArm    golden :1741-1760
//     ATC60System::SendTestStart       golden :1762-1782
//     ATC60System::CloseSocket         golden :1784-1803
//     ATC60System::OpenSocket          golden :1805-1824
//     ATC60System::IsConnected         golden :1826-1836
//     ATC60System::IsConnecting        golden :1838-1841
//     ATC60System::TransformTjData     golden :1843-1882
//     ATC60System::SetTjOffset         golden :1887-2045
//     ATC60System::SaveTjLog           golden :2047-2056
//     ATCSystem::GetNowATCSwVer        golden :2058-2062
//     ATCSystem::SetATCTimeSync        golden :2064-2068
//     HT_ATC::SetATCTimeSync           golden :2070-2080
//     ATCSystem::Set2ndTempFunction    golden :2082-2086
//     HT_ATC::Set2ndTempFunction       golden :2088-2101
//     ATCSystem::SetATCSelfTest        golden :2103-2107
//     ATCSystem::GetNowATCStatus       golden :2109-2113
//     ATCSystem::SetATCManualSelfTest  golden :2115-2119
//     ATCSystem::GetNowSelfTestStatus  golden :2121-2125
//   Plus the module-scope global `CRITICAL_SECTION g_WriteCommand;` (golden
//   :1163) and static `TQPF_Timer HATC60TimeOut;` (golden :1250).
//   golden's commented-out `ATCSystem::CheckTemperatureSetOK` (:1002-1014) is
//   preserved verbatim as a comment (it is already dead in golden).
//   SATISFIED-BY-SUBSTRATE (already real in this tree, nothing shimmed here):
//     TCPIP/TCPClient (ATC/TCPData.cpp, PT-W2), HThreadCtrl (HThreadCtrl/
//     HThreadCtrl.cpp, PT-W2), Scktcomp::TClientSocket/TCustomWinSocket
//     (vclcompat/ClientSocket.cpp), MySleep/MySleepEx (common.cpp),
//     Temperature.bUseReferTempSensor (cprod.h/.cpp), bATCWaterTempAlarm/
//     iATCForHSMode/sATCVerRead/iATC_TempIndex/OLD_VALUES/SAME_COUNT
//     (cmydef.h/.cpp), MyDBIProcess (declared cMyDB.h, real body
//     SECSGEM/uHGemEquipment.cpp), StringReplace/TReplaceFlags/IntToStr/
//     FormatDateTime/Now/DecodeTime (vclcompat/SysUtils.*, TDateTime.*),
//     TStringList (vclcompat/TStringList.*), TQPF_Timer (myTimer.h/.cpp).
//     ATCInterfaceForm (this wave's own ATC/ATCInterface.{h,cpp} -- lands in
//     the SAME wave, so the one cross-reference from ATC60System::
//     ClientSocket1Connect is ACTIVE, not gated).
//
//  GATE REGISTER -- exactly ONE gate, grep-verified against the WHOLE port
//  tree (excluding build*/) before being declared, per house rule 6:
//   (1) `ShowMessage(vReciveBuf[i]);` (golden ATC60System::DoCommmand :1340,
//       inside the `if(vReciveBuf.size()>1)` diagnostic-dump branch) -- golden
//       Dialogs.hpp's real VCL modal `void ShowMessage(const AnsiString&)`.
//       Grepped the WHOLE port tree: no port of this global exists anywhere
//       (it is distinct from this project's OWN `ShowMyMessage` wrapper in
//       canary_support.h, which IS real and is NOT what golden calls here).
//       This is the exact same gap SECSGEM/uHGemEquipment.cpp's own
//       `Gated_ShowMessage` and ProductionInfo/TfFTP.cpp's own
//       `Gated_ShowMessage` already record and gate -- same idiom reused
//       here rather than reinvented, per house rule 6 ("guessing here is the
//       single most common way these waves go wrong": this is a KNOWN,
//       already-classified gap, not a guess).
//       WHY A LOCAL no-op IS THE FAITHFUL DEFAULT: golden's own call site is
//       purely diagnostic (dumping every buffered line when more than one
//       arrived in a single poll, ChungHung's own debug aid); no other golden
//       state is touched by it and no caller inspects a return value. Skipping
//       the modal advisory changes nothing observable in DoCommmand's own
//       control flow (the very next statement after the loop already re-reads
//       vReciveBuf[0] unconditionally).
//       BEHAVIOUR DELTA, STATED PLAINLY: on a real machine, if two ATC 6.0/3.0
//       replies are ever buffered before one poll drains them, golden pops up
//       a modal dialog per buffered line (blocking the ATC60System UI thread
//       until dismissed); this build silently skips that dialog and proceeds.
//       Retire this gate once a real VCL-style modal ShowMessage lands
//       (tracked centrally by the two existing Gated_ShowMessage sites).
//
//  VCL/Borland conversions: `#pragma hdrstop` / `#pragma package(smart_init)`
//  dropped (golden :2, and there is no `#pragma package` in this .cpp at all
//  -- ATCSystem.cpp is a non-form unit).  golden's `#include "mymessbox.h"`
//  and `#include "ATC_Handler_Side.h"` are NOT re-included here: neither
//  symbol either header would provide is referenced by any translated body
//  above (ShowMyMessage/note.h machinery is not called anywhere in this file;
//  ATC_Handler_Side.h is a SEPARATE golden ATC-7.0-style handler-side unit,
//  out of THIS wave's two-file scope, and grep confirms zero identifiers from
//  it appear in ATCSystem.cpp's body).  `String` parameters (golden HT_ATC::
//  LotStart/LotEnd, ATCSystem::LotStart/LotEnd) are spelled `AnsiString`, per
//  ATCSystem.h's own banner note.  `__fastcall` does not occur in this
//  golden .cpp at all (ATC60System's ctor/dtor/NewSocket/etc. carry it in
//  golden -- dropped here, matching the header).
//
...
#include "ATC/ATCSystem.h"
#include "cmydef.h"                                                             // 2012.02.02 , Joye ,  ATC改; bATCWaterTempAlarm/iATCForHSMode/sATCVerRead/iATC_TempIndex/OLD_VALUES/SAME_COUNT
#include "cprod.h"                                                               // Temperature.bUseReferTempSensor
#include "ATC/ATCInterface.h"                                                    // ATCInterfaceForm (ATC60System::ClientSocket1Connect -- same wave)
#include "aHotPlateSubstrate.h"                                                  // MyDBIProcess(AnsiString,AnsiString) real declaration/body reach
#include "common.h"                                                              // MySleep/MySleepEx real bodies
#include "Public/WinSocketErrorCode.h"                                           // GetErrorMsg(TObject*,int) -- ATC60System::ClientSocket1Error

//---------------------------------------------------------------------------
// AI(W906-PT-W3) 20260807: golden Dialogs.hpp `void ShowMessage(const AnsiString&)`
// -- see this file's own GATE REGISTER entry (1). Same idiom as SECSGEM/
// uHGemEquipment.cpp's / ProductionInfo/TfFTP.cpp's own Gated_ShowMessage.
static void W906_ATCSystem_Gated_ShowMessage(const AnsiString & /*S*/)
{
...
//---------------------------------------------------------------------------
void HT_ATC::LotStart(AnsiString sLotID)                                        //Ifor 20161118 add ATC2.0 Lot Start Command for KYEC
{
    AnsiString sSendData;
...
//---------------------------------------------------------------------------
void HT_ATC::LotEnd(AnsiString sLotID)                                          //Ifor 20161118 add ATC2.0 Lot Start Command for KYEC
{
    AnsiString sSendData;
...
//---------------------------------------------------------------------------
void ATCSystem::LotStart(AnsiString sLotID)                                     //Ifor 20161118 add ATC2.0 Lot Start Command for KYEC
{
    ((HT_ATC*)(Channels[0]))->LotStart(sLotID);
}
//---------------------------------------------------------------------------
void ATCSystem::LotEnd(AnsiString sLotID)                                       //Ifor 20161118 add ATC2.0 Lot End Command for KYEC
{
...
void ATC60System::NewSocket()                                                   //ChungHung 20141211 add
{
    ...
    // MINIMAL NECESSARY ADAPTATION: golden's 4 event-property assignments
    // rely on BCB6's __closure implicit `this`-binding, which standard C++
    // has no syntax for -- same idiom as this tree's established precedent,
    // ATC/TCPData.cpp:189-192 / MyPLC/ModbusTCPClient.cpp:34-37.
    clientsocket->OnConnect     =[this](TObject *Sender, TCustomWinSocket *Socket){ ClientSocket1Connect(Sender, Socket); };
    clientsocket->OnDisconnect  =[this](TObject *Sender, TCustomWinSocket *Socket){ ClientSocket1Disconnect(Sender, Socket); };
    clientsocket->OnRead        =[this](TObject *Sender, TCustomWinSocket *Socket){ clientsocketRead(Sender, Socket); };
    clientsocket->OnError       =[this](TObject *Sender, TCustomWinSocket *Socket, TErrorEvent ErrorEvent, int &ErrorCode){ ClientSocket1Error(Sender, Socket, ErrorEvent, ErrorCode); };
...
//---------------------------------------------------------------------------
static TQPF_Timer HATC60TimeOut;                                                //ChungHung 20141105 add for ATC6.0 & 3.0
void ATC60System::SendCommand()
{
    ...
    {
        // ADAPTED: golden Socket->Lock()/Unlock() bracket the send -- TCustomWinSocket has no Lock/Unlock (no port; vclcompat's SendText is already a single non-reentrant call, so the bracketing has nothing to protect against here) -- dropped, SendText kept.
...
void ATC60System::DoCommmand()
{
    ...
    if(vReciveBuf.size()>1)
    {
        for(unsigned int i=0; i<vReciveBuf.size(); i++)
            W906_ATCSystem_Gated_ShowMessage(vReciveBuf[i]);                    //AI(W906-PT-W3) 20260807: golden ShowMessage(vReciveBuf[i]) -- see GATE (1)
    }
...
//---------------------------------------------------------------------------
void ATC60System::ClientSocket1Connect(TObject *Sender,
...
//---------------------------------------------------------------------------
void ATC60System::ClientSocket1Disconnect(TObject *Sender,
      TCustomWinSocket *Socket)
{
    Connected =false;
    Connecting=false;
...
//---------------------------------------------------------------------------
void ATC60System::clientsocketRead(TObject *Sender,
      TCustomWinSocket *Socket)
{
    ...
    DecodeTime(rTime, thour, tmin, tsec, tmsec);                                //AI(W906-PT-W3) 20260807: golden `rTime.DecodeTime(&h,&m,&s,&ms)` (BCB6 TDateTime method) -- this tree's TDateTime (vclcompat/TDateTime.h) exposes DecodeTime only as a free function taking by-reference outs; same operation, zero behaviour delta
    rStr.sprintf("%d:%d:%d:%d  ,%s", thour, tmin, tsec, tmsec, rRec);
}
//------------------------------------------------------------------------------
void ATC60System::ClientSocket1Error(TObject *Sender,
...
void ATC60System::CloseSocket()
{
    try
    {
        if(clientsocket->Active==false)
            return;
        // ADAPTED: golden Socket->Lock()/Unlock() bracket the Close() -- see SendCommand's own identical note.
        clientsocket->Close();
        vReciveBuf.clear();
        Connecting=false;
...
void ATC60System::SetTjOffset(AnsiString buffer)
{
    ...
    if(Temperature.bATCActiveCooling && Temperature.bUseTjFunction)
    {
        ...
        {                                                                       //要將offet 補到下一顆Device ,所以當Arm1進測區就Set Arm2
            int iwhichArm=AnsiString(sTjList->Strings[1]).ToIntDef(0);

            if(iwhichArm==0)
            {
                for(int i=0; i<8; i++)
                {
                    TjOffset[i]=AnsiString(sTjList->Strings[2+i]).ToDouble();
                    TjTemp=TjOffset[8+i];
            ...
            else
            {
                for(int i=0; i<8; i++)
                {
                    TjOffset[8+i]=AnsiString(sTjList->Strings[10+i]).ToDouble();
                    TjTemp=TjOffset[i];
        ...
        else if(Temperature.iTjMode==1)                                         //real time
        {
            ...
            if(iwhichArm==0)
            {
                for(int i=0; i<8; i++)
                {
                    TjTemp=AnsiString(sTjList->Strings[2+i]).ToDouble();
                    if(TjTemp>0)
                    {
                        TjTemp=Temperature.fWorkTemperBase-TjTemp;
            ...
            else
            {
                for(int i=0; i<8; i++)
                {
                    TjTemp=AnsiString(sTjList->Strings[10+i]).ToDouble();
                    if(TjTemp>0)
                    {
                        TjTemp=Temperature.fWorkTemperBase-TjTemp;
