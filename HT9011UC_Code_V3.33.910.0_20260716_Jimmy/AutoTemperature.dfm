object ACTForm: TACTForm
  ...
  object pcACT: TPageControl
    ...
    object tsSetup: TTabSheet
      ...
      object gbACTTCPIP: TGroupBox
        Left = 688
        Top = 29
        Width = 313
        Height = 110
        Caption = 'TCP/IP Port Setting'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
        Font.Name = 'Arial'
        ...
        object btACTTrigger: TButton
          ...
          ParentFont = False
          TabOrder = 0
          OnClick = btACTTriggerClick
        end
        object edACTCMD: TEdit
          Left = 211
          Top = 46
          Width = 90
          Height = 26
  ...
  object ClientSocketACT: TClientSocket
    Tag = 4
    Active = False
    ClientType = ctNonBlocking
    Port = 0
    OnRead = ClientSocketACTRead
    Left = 712
  end
  object ACTConnectTimer: TTimer
    Interval = 50
    OnTimer = ACTConnectTimerTimer
    Left = 741
  end
end
