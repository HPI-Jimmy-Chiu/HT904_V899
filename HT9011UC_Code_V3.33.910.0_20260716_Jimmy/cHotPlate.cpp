...
//    if(HotPlateForm_File.XPitch==26.67)                                       //Steven 20241212 : 26.67 x 3 = 8001 //Steven 20260716 : Mark
//    {
...
//    }
    ...
    if(HotPlateForm_File.iPlateSelect==1)                                       //JerryYang 20250120 : add
    {
        iSECS_HotPlateSeclect=1;
    }
    else if(HotPlateForm_File.iPlateSelect==2)
    {
        iSECS_HotPlateSeclect=2;
    }
    else
    {
        iSECS_HotPlateSeclect=0;
    }
