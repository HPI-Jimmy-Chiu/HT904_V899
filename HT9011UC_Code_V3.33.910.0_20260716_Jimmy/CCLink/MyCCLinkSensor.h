...
__published:    // IDE-managed Components
    ...
    TButton *btIn4_15;
    TButton *Button1;
    TTabSheet *tsSocketBase3;
    TGroupBox *gbInSHLtcPercent;
    TPanel *Panel7;
    TLabel *Label38;
    TEdit *edtInShtLtcPercent;
    TPanel *Panel8;
    TALed *SocketLED25;
    TALed *SocketLED26;
    TALed *SocketLED27;
    ...
    void __fastcall btIn4_1MouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y);
    void __fastcall btIn5_1MouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y);
private:    // User declarations
public:     // User declarations
    TTMyTray *TMyTrayPtr[12];                                                   //kevin 20130420[6];
    TEdit *EditPtr[64];                                                         //kevin 20130420 [20];
    TButton *ButtonPtr[64];                                                     //kevin 20130420 [20];
    TALed *LamePtr[64];                                                         //kevin 20130420 [20];
...
extern void SingleSetValue(int itag, int iValue);                               //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
extern int  SingleGetValue(int itag, int iPercen);                              //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
#endif
