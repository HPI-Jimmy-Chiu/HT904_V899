...
extern bool bCheckMagazineSafeSensor();                                         //Sam 20221116 : Magazine TrayArm 自動補 Tray
extern void InitialDoMagazineScanHasTray();
extern bool DoMagazineScanHasTray();
extern AnsiString AMRUnloadBin(int iPos);                                 //a-side Magazine.h L186  //Eastsun 20260512 F011 整合 (Phase4-F5T3 forward decl AMRUnloadBin)
//---------------------------------------------------------------------------
#endif

//==> Eastsun 20260512 F012 整合 (AMR Magazine externs)
extern bool DoPickFromAuto(bool bReset);
extern bool DoPlaceToAuto1(int iwhichAuto, bool bReset);
extern int  SearchNeedAMRUnload(bool bTrayfeed);
extern int  SearchNeedAMRUnloadCount();
extern int  SearchAMRUnloadPos(int iWhichAMRAuto);
extern bool bSearchNeedAMRUnloadMode(bool b,int iMageIndex);
extern int  BinTansferMagazine(int iAuto);
extern void InitialDoMagazineAMRTrayFeed();
extern bool DoMagazineAMRTrayFeed(int iWhichMRAuto);
extern int  iDoPickFromAutoTask;
extern int  iDoPlaceToAuto1Task;
extern int  iDoMagazineAMRTrayFeedTask;
