...
//    bool bSLTReportFunction;                                                  //Steven 20180420 : SLT報表功能
...
//    bool bIndexPickErrNeedPiggyBack;                                          //jou 20171211 (Steven) : After index pick up error, device go to Error bin ,follow by Index check or piggy back check
    ...
    bool bUseATCFileTransfer;                                                   //Eastsun 20260522 整合: ATC Recipe FileTransfer (KYEC)
    ...
    bool bEnable_1x3Kit;                                                        //KevinCheng 20260109 : 1x2Site and 2x2 NN mode 使用1x3Site Kit
...
//    bool bLoadPickUpErrorMES0101Record;                                         //Sam 20200922 : Pick up Error Production_Log 也要記錄
    ...
    bool bPickerLifeAlmNeedOneCycle;                                            //AI(ht9045-config) 20260521 (RogerYang) : SCC吸嘴壽命報警OneCycle優化
    ...
    bool bSetOffsetLimitToAll;                                                  //JerryYang 20230215 : ASE-CL 尚智要求一鍵設定Offset limit
    bool bUseConfigSaveButton;                                                  //JerryYang 20230215 : ASE-CL 尚智要求follow 7000軟體新增config存檔按鈕
    bool bD44Use4ea;
