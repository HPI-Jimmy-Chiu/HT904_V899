...
//##############################################################################
        ...
        void __fastcall ReportAlarm(AnsiString AlarmCode, bool bIsJam, int iDuplicateError, AnsiString SubMessage, bool bReleaseAlm=false, AnsiString Recovery="");     //JerryYang (Steven) 20170504 bReleaseAlm為true表示解除alarm需上報0x00
