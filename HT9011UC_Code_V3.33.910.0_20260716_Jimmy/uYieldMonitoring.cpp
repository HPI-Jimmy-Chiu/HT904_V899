...
#include "ProductionInfo.h"                                                     //AI(ht9045-v899) 20260519: SaveInfoFileWhenStart for GTK RunSite after low-yield auto site-off
...
//Low Yield Alarm(%) [Socket Yield compare with Total Yield]
    ...
    cbSlidingWindowYield->Checked   =TestIF_File.bSlidingWindowYield;           //Steven 20260331 : Sliding Window Yield
    edSlidingWindowSize->Text       =TestIF_File.iSlidingWindowSize;            //Steven 20260331
...
//Consecutive Failure Alarm ( Head)
    ...
    if(CosFunction.bAdaptiveYield)                                              //Sam 20230914 : 自適應性良率監控
    {
        ...
        TCheckBox *cbByBinFailCountCat_FT[16]={cbBybinLimitCat0_FT,cbBybinLimitCat1_FT,cbBybinLimitCat2_FT,cbBybinLimitCat3_FT,                                 //JerryYang 20250120 : add
                                             cbBybinLimitCat4_FT,cbBybinLimitCat5_FT,cbBybinLimitCat6_FT,cbBybinLimitCat7_FT,
                                             cbBybinLimitCat8_FT,cbBybinLimitCat9_FT,cbBybinLimitCat10_FT,cbBybinLimitCat11_FT,
                                             cbBybinLimitCat12_FT,cbBybinLimitCat13_FT,cbBybinLimitCat14_FT,cbBybinLimitCat15_FT};

        TCheckBox *cbByBinFailCountCat_RT[16]={cbBybinLimitCat0_RT,cbBybinLimitCat1_RT,cbBybinLimitCat2_RT,cbBybinLimitCat3_RT,
                                             cbBybinLimitCat4_RT,cbBybinLimitCat5_RT,cbBybinLimitCat6_RT,cbBybinLimitCat7_RT,
                                             cbBybinLimitCat8_RT,cbBybinLimitCat9_RT,cbBybinLimitCat10_RT,cbBybinLimitCat11_RT,
                                             cbBybinLimitCat12_RT,cbBybinLimitCat13_RT,cbBybinLimitCat14_RT,cbBybinLimitCat15_RT};

        TEdit *edByBinFailCountCat_FT[16]={edByBinLimitCountCat0_FT,edByBinLimitCountCat1_FT,edByBinLimitCountCat2_FT,edByBinLimitCountCat3_FT,                 //JerryYang 20231206
                                         edByBinLimitCountCat4_FT,edByBinLimitCountCat5_FT,edByBinLimitCountCat6_FT,edByBinLimitCountCat7_FT,
                                         edByBinLimitCountCat8_FT,edByBinLimitCountCat9_FT,edByBinLimitCountCat10_FT,edByBinLimitCountCat11_FT,
                                         edByBinLimitCountCat12_FT,edByBinLimitCountCat13_FT,edByBinLimitCountCat14_FT,edByBinLimitCountCat15_FT};

        TEdit *edByBinFailCountCat_RT[16]={edByBinLimitCountCat0_RT,edByBinLimitCountCat1_RT,edByBinLimitCountCat2_RT,edByBinLimitCountCat3_RT,
                                         edByBinLimitCountCat4_RT,edByBinLimitCountCat5_RT,edByBinLimitCountCat6_RT,edByBinLimitCountCat7_RT,
                                         edByBinLimitCountCat8_RT,edByBinLimitCountCat9_RT,edByBinLimitCountCat10_RT,edByBinLimitCountCat11_RT,
                                         edByBinLimitCountCat12_RT,edByBinLimitCountCat13_RT,edByBinLimitCountCat14_RT,edByBinLimitCountCat15_RT};
    ...
    if(CosFunction.bByBinAlarmFromYieldForm)                                    //jou 20180113 (Steven) : By Site By Bin Percent Compare From Yield form
    {
        ...
        for(int i=0; i<16; i++)                                                 //RogerYang 20260409 : TEST_MAX_BIN會溢位，暫時放給它過
        {
            cbByBinFailCountCat_FT[i]->Checked=TestIF_File.bFailCountEnable[FT][i];      //JerryYang 20231207
            cbByBinFailCountCat_RT[i]->Checked=TestIF_File.bFailCountEnable[RT][i];
            edByBinFailCountCat_FT[i]->Text=TestIF_File.iFailCountLimit[FT][i];
            edByBinFailCountCat_RT[i]->Text=TestIF_File.iFailCountLimit[RT][i];
        }
        ...
        edByBinLimitCountCatCT_FT->Text=TestIF_File.iFailCountIgnore[FT];
        edByBinLimitCountCatCT_RT->Text=TestIF_File.iFailCountIgnore[RT];
    }
...
//Low Yield Alarm(%)
    ...
    TestIF_File.bSlidingWindowYield                 =cbSlidingWindowYield->Checked;                                     //Steven 20260331 : Sliding Window Yield
    TestIF_File.iSlidingWindowSize                  =CheckRange(atoi(edSlidingWindowSize->Text.c_str()), 10, 2000);     //Steven 20260331
...
//Consecutive Failure Ignore                                                    //wei 20160115 銅鑼前幾顆不計算ContsFail
    ...
    TCheckBox *cbByBinFailCountCat_FT[16]={cbBybinLimitCat0_FT,cbBybinLimitCat1_FT,cbBybinLimitCat2_FT,cbBybinLimitCat3_FT,
                                         cbBybinLimitCat4_FT,cbBybinLimitCat5_FT,cbBybinLimitCat6_FT,cbBybinLimitCat7_FT,
                                         cbBybinLimitCat8_FT,cbBybinLimitCat9_FT,cbBybinLimitCat10_FT,cbBybinLimitCat11_FT,
                                         cbBybinLimitCat12_FT,cbBybinLimitCat13_FT,cbBybinLimitCat14_FT,cbBybinLimitCat15_FT};
    ...
    if(CosFunction.bByBinAlarmFromYieldForm)                                    //jou 20180113 (Steven) : By Site By Bin Percent Compare From Yield form
    {
        ...
        for(int i=0; i<16; i++)                                                 //RogerYang 20260409 : TEST_MAX_BIN會溢位，暫時放給它過
        {
            TestIF_File.bFailCountEnable[FT][i]=cbByBinFailCountCat_FT[i]->Checked;                                     //JerryYang 20231206
            TestIF_File.bFailCountEnable[RT][i]=cbByBinFailCountCat_RT[i]->Checked;
            TestIF_File.iFailCountLimit[FT][i]=CheckRange(atoi(edByBinFailCountCat_FT[i]->Text.c_str()), 0, 100000);
            TestIF_File.iFailCountLimit[RT][i]=CheckRange(atoi(edByBinFailCountCat_RT[i]->Text.c_str()), 0, 100000);
        }
        ...
        TestIF_File.iFailCountIgnore[FT]=CheckRange(atoi(edByBinLimitCountCatCT_FT->Text.c_str()), 20, 100000);         //JerryYang 20231206
        TestIF_File.iFailCountIgnore[RT]=CheckRange(atoi(edByBinLimitCountCatCT_RT->Text.c_str()), 20, 100000);
    }
...
//Low Yield Alarm(%)
    ...
    WriteIniData(szDir, "Low Yield Alarm", "Sliding Window Enable", int(TestIF_File.bSlidingWindowYield));              //Steven 20260331 : Sliding Window Yield
    WriteIniData(szDir, "Low Yield Alarm", "Sliding Window Size",   int(TestIF_File.iSlidingWindowSize));               //Steven 20260331
...
//Steven 20110426 End
    ...
    if(CosFunction.bByBinAlarmFromYieldForm)                                    //jou 20180113 (Steven) : By Site By Bin Percent Compare From Yield form
    {
        ...
        for(int i=0; i<iTestBinCount; i++)
        {
            ...
            asSpecBinBySiteCompare.printf("bFailCountEnable%02d_FT",i);
            WriteIniData(szDir, "Alarm",     asSpecBinBySiteCompare,           TestIF_File.bFailCountEnable[FT][i]);
            asSpecBinBySiteCompare.printf("bFailCountEnable%02d_RT",i);
            WriteIniData(szDir, "Alarm",     asSpecBinBySiteCompare,           TestIF_File.bFailCountEnable[RT][i]);

            asSpecBinBySiteCompare.printf("iFailCountLimit%02d_FT",i);
            WriteIniData(szDir, "Alarm",     asSpecBinBySiteCompare,           int(TestIF_File.iFailCountLimit[FT][i]));
            asSpecBinBySiteCompare.printf("iFailCountLimit%02d_RT",i);
            WriteIniData(szDir, "Alarm",     asSpecBinBySiteCompare,           int(TestIF_File.iFailCountLimit[RT][i]));
        }
        ...
        WriteIniData(szDir, "Alarm",     "iFailCountIgnore_FT",    int(TestIF_File.iFailCountIgnore[FT]));              //JerryYang 20231206
        WriteIniData(szDir, "Alarm",     "iFailCountIgnore_RT",    int(TestIF_File.iFailCountIgnore[RT]));
    }
...
//        gbYieldAlarmRT->Enabled=false;   //JerryYang 20221130 :
//        gbAlarmRT->Enabled=false;
    }
...
//---------------------------------------------------------------------------
//=== Sliding Window Ring Buffer Methods ===                                     //Steven 20260331
