...
AnsiString asTrayIDByLot            ="D:\\HT9045_Log\\2DBarCode\\TrayIDByLot.txt";  //JerryYang 20250120 : add
...
//AnsiString asGAILLogPath            ="D:\\HT9045_Log\\Galil_Log";               //kevin 20150909 : 紀錄Gail 通訊
...
AnsiString asSocketIDLogPath        ="D:\\HT9045_Log\\SocketIDLog\\";           //JerryYang 20250120 : add
...
AnsiString asBarCodeInspReportPath  ="D:\\HT9045_Log\\2DIDParameterReport";     //Eastsun 20260527 整合//Sam 20240426 : Add BarCoder Inspection Report
...
AnsiString asMachineLifePath         ="D:\\HT9045\\system\\MachineLife.ini";    //Eastsun 20250521 整合//Sam 20230516 : Pre Alrm Cylinder
...
AnsiString asSWVersionPath           ="D:\\HT9045_log\\SW_Version\\";           //KevinCheng 20251120 : N17 SwVersion
...
AnsiString asATCFileTransferPath     ="D:\\ATC\\Data\\SaveFile\\";              //Eastsun 20260522 add: ATC Recipe FileTransfer path
...
//    asGAILLogPath        ="D:\\HT9045_Log\\Galil_Log";                          //kevin 20150909 : 紀錄Gail 通訊
    ...
    asBarCodeInspReportPath  ="D:\\HT9045_Log\\2DIDParameterReport";            //Eastsun 20260527 整合 //Sam 20240426 : Add BarCoder Inspection Report
    asDupBundleID            ="D:\\HT9045_Log\\BundleID\\DupBundleID.txt";
    aslDupUnloadBundlID      ="D:\\HT9045_Log\\BundleID\\DupUnloadBundleID.txt";
    asMachineLifePath        ="D:\\HT9045\\system\\MachineLife.ini";            //Eastsun 20260521 整合//Sam 20230516 : Pre Alrm Cylinder
}
//---------------------------------------------------------------------------
...
int MyForceDirectories(AnsiString Directory, AnsiString Function)               //Steven 20210112 : 針對資料夾加上保護
{
    ...
    if(Directory[Directory.Length()]!='\\')                                     //Steven 20260505 : Auto-detect filename component
    {
        ...
        if(attr!=INVALID_FILE_ATTRIBUTES)                                       //RogerYang 20260527 : Fix - INVALID treats as dir-to-create
        {
            if(!(attr & FILE_ATTRIBUTE_DIRECTORY))
                Directory=ExtractFilePath(Directory);                           //路徑存在：確認是檔案才 strip
        }
        else
        {
            AnsiString sExt=ExtractFileExt(Directory).LowerCase();              //RogerYang 20260603 : 只卡控明確的檔案副檔名，避免誤判含「.」的目錄名
