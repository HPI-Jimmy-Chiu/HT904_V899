    ...
    : TForm(Owner)
{
    ...
    for(int i=0; i<2; i++)
    {
        ...
        bSortArmZHome[i]=true;                                                  //RogerYang 20250416 for HT9046AU add
    }
    ...
    TEdit *teSortArm[2]={editsetEditZ3A, editsetEditZ3B};                       //RogerYang 20250416 for HT9046AU add
    ...
    for(int i=0; i<2; i++)
    {
        ...
        SortZEditPtr[i]             =teSortArm[i];                              //RogerYang 20250416 for HT9046AU add
    }
    ...
    if(USE_OUT_SORT_ARM!=eartUninstall)                                         //RogerYang 20250416 for HT9046AU add
    {
        ...
        TechSuckPara[2].SetEdit[0][0]       =teSortArm[0];
        ...
        TechSuckPara[2].SetEdit[0][1]       =teSortArm[1];
...
*/
    ...
    TechPara.push_back(new TECH_PARA(&Teach.iContactZ1Relative              ,   MTestZ1         ,seteditContactZ1Relative   , "seteditContactZ1Relative"    , SetButton077          ,GoButton077));
    TechPara.push_back(new TECH_PARA(&Teach.iContactZ2Relative              ,   MTestZ2         ,seteditContactZ2Relative   , "seteditContactZ2Relative"    , SetButton078          ,GoButton078));
    ...
    if(USE_OUT_SORT_ARM!=eartUninstall)                                         //RogerYang 20250416 for HT9046AU add
    {
        TechPara.push_back(new TECH_PARA(&Tech.iSortShuttleLeft      ,   MOutSortSht     , edtOutSortSht_L              , "edtOutSortSht_L"           , btnSetSortShtL              , btnGoSortShtL));
        TechPara.push_back(new TECH_PARA(&Tech.iSortShuttleRight     ,   MOutSortSht     , edtOutSortSht_R              , "edtOutSortSht_R"           , btnSetSortShtR              , btnGoSortShtR));
        TechPara.push_back(new TECH_PARA(&Tech.iSortArmXPitchMin     ,   MOutSortPitchX  , edtsetSortXPitchMin          , "edtsetSortXPitchMin"       , btnSetSortArmXMin           , btnGoSortArmXMin));
        TechPara.push_back(new TECH_PARA(&Tech.iSortArmXPitchMax     ,   MOutSortPitchX  , edtsetSortXPitchMax          , "edtsetSortXPitchMax"       , btnSetSortArmXMax           , btnGoSortArmXMax));
        TechPara.push_back(new TECH_PARA(&Tech.iSortArmShuttlePickZ  ,   MOutSortAb      , edtSetPickSortSHT            , "edtSetPickSortSHT"         , btnSetSortShtPick           , btnGoSortShtPick));
        TechPara.push_back(new TECH_PARA(&Tech.iSortArmAutoPlaceZ    ,   MOutSortAb      , edtSetPlaceSortAuto          , "edtSetPlaceSortAuto"       , btnSetAutoPlace             , btnGoAutoPlace));
        TechPara.push_back(new TECH_PARA(&Tech.iSortArmSafeZ1        ,   MOutSortAb      , edtSetSortZSafeHeight        , "edtSetSortZSafeHeight"     , btnSetSortZSafeHeight       , btnGoSortZSafeHeight));
        TechPara.push_back(new TECH_PARA(&Tech.iOutArmToSortShtPlaceZ,   MOutArmZE       , edtSetOutArmToSortShtPlace   , "edtSetOutArmToSortShtPlace", btnSetOutArmToSortShtPlace  , btnGoOutArmToSortShtPlace));
    }
...
//  #endif
    ...
    if(USE_OUT_SORT_ARM!=eartUninstall)                                         //RogerYang 20250416 for HT9046AU add
    {
        TechMotorAxle.push_back(new TECH_MotorAxle(MOutSortX            , MotorSortArmX));
        TechMotorAxle.push_back(new TECH_MotorAxle(MOutSortY            , MotorSortArmY));
        TechMotorAxle.push_back(new TECH_MotorAxle(MOutSortPitchX       , MotorSortArmPitchX));
        TechMotorAxle.push_back(new TECH_MotorAxle(MOutSortPitchX       , btnSortXPitch));
        TechMotorAxle.push_back(new TECH_MotorAxle(MOutSortAa           , MotorSortArmZA));
        TechMotorAxle.push_back(new TECH_MotorAxle(MOutSortAb           , MotorSortArmZB));
        TechMotorAxle.push_back(new TECH_MotorAxle(MOutSortSht          , MotorSortSHT));
    }
    ...
    TechMotorAxle.push_back(new TECH_MotorAxle(MTopAOIArmX      ,MotorTopAOIArmX    , USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall));     //Jimmychiu 20240322 : Top & Bottom Inspect
    TechMotorAxle.push_back(new TECH_MotorAxle(MTopAOIArmY      ,MotorTopAOIArmY    , USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall));     //Jimmychiu 20240322 : Top & Bottom Inspect
    TechMotorAxle.push_back(new TECH_MotorAxle(MTopAOIArmR      ,MotorTopAOIArmR    , USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall));     //Jimmychiu 20240322 : Top & Bottom Inspect
    TechMotorAxle.push_back(new TECH_MotorAxle(MTopAOICCDZ      ,MotorTopAOICCDZ    , USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall));     //Jimmychiu 20240322 : Top & Bottom Inspect
    ...
    TechMotorAxle.push_back(new TECH_MotorAxle(MLoaderY             , btnLoaderY            , INSTALL_OCR_YMot==eocrYMotInstal ||
    ...
    if(USE_OUT_SORT_ARM!=eartUninstall)                                         //RogerYang 20250416 for HT9046AU add
    {
        TechTwoPara.push_back(new TECH_TWOPARA(&Tech.iSortArmShtStageX      ,   &Tech.iSortArmShtStageY         ,   MOutSortX       , MOutSortY       , edtOutSortArmShtL_X , edtOutSortArmShtL_Y   , "edtOutSortArmShtL_X"     , "edtOutSortArmShtL_Y"     , btnSetSortArmToSHT    , btnGoSortArmToSHT));
        TechTwoPara.push_back(new TECH_TWOPARA(&Tech.iSortArmAuto4X         ,   &Tech.iSortArmAuto4Y            ,   MOutSortX       , MOutSortY       , edtOutSortArmAuto4_X, edtOutSortArmAuto4_Y  , "edtOutSortArmAuto4_X"    , "edtOutSortArmAuto4_Y"    , btnSetSortArmToAuto4  , btnGoSortArmToAuto4));
        TechTwoPara.push_back(new TECH_TWOPARA(&Tech.iSortArmAuto5X         ,   &Tech.iSortArmAuto5Y            ,   MOutSortX       , MOutSortY       , edtOutSortArmAuto5_X, edtOutSortArmAuto5_Y  , "edtOutSortArmAuto5_X"    , "edtOutSortArmAuto5_Y"    , btnSetSortArmToAuto5  , btnGoSortArmToAuto5));
        TechTwoPara.push_back(new TECH_TWOPARA(&Tech.iSortArmAuto6X         ,   &Tech.iSortArmAuto6Y            ,   MOutSortX       , MOutSortY       , edtOutSortArmAuto6_X, edtOutSortArmAuto6_Y  , "edtOutSortArmAuto6_X"    , "edtOutSortArmAuto6_Y"    , btnSetSortArmToAuto6  , btnGoSortArmToAuto6));
        TechTwoPara.push_back(new TECH_TWOPARA(&Tech.iOutArmSortShtX        ,   &Tech.iOutArmSortShtY           ,   MOutArmX        , MOutArmY        , edtOuttArmShtR_X    , edtOuttArmShtR_Y      , "edtOuttArmShtR_X"        , "edtOuttArmShtR_Y"        , btnSetOutArmToSHT     , btnGoOutArmToSHT));
    }
...
void __fastcall TfTeach::ScrollBar1Change(TObject *Sender)
{
    ...
    if(ActiveMotorIndex==-1)
        return;
    Speed=ScrollBar1->Position;
    MOT[ActiveMotorIndex].SetSpeed(Speed/3, true);                              //RogerYang 20250729 Add for 9046AU
    edtSpeed->Text=Speed;
}
//---------------------------------------------------------------------------
...
//    fTeach->DoIniDataToForm();                                                //KenHsieh 20210813 : add CCD AUTO ALIGNMENT
    ...
    SetButtonInSh1LtcSenZ1->Tag=MotorInSh1LtcZ1->Tag;                           //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
    SetButtonInSh1LtcSenZ2->Tag=MotorInSh1LtcZ2->Tag;
    SetButtonInSh2LtcSenZ1->Tag=MotorInSh2LtcZ1->Tag;
    SetButtonInSh2LtcSenZ2->Tag=MotorInSh2LtcZ2->Tag;
    ...
    if(USE_OUT_SORT_ARM!=eartUninstall)                                         //RogerYang 20250416 for HT9046AU add
    {
        TechSuckPara[2].funButton=btnSetSortArmZ;
        TechSuckPara[2].funButton->GroupIndex=1;
        TechSuckPara[2].funButton->AllowAllUp=true;
        TechSuckPara[2].funButton->Tag=0;
        TechSuckPara[2].btGo=btnGoSortArmZ;
        TechSuckPara[2].btGo->GroupIndex=1;
        TechSuckPara[2].btGo->AllowAllUp=true;
        TechSuckPara[2].btGo->Tag=2;

        for(int i=0; i<2; i++)
        {
            if(TechSuckPara[2].SetEdit[0][i]!=NULL)
                TechSuckPara[2].SetEdit[0][i]->Text=(int)(*TechSuckPara[2].Parameter[0][i]);
        }
        TechSuckPara[2].SetEdit[0][1]->Enabled=false;
    }
...
//    bOutArmAllUp=false;
    ...
    MotorOutArmPitchY->Visible  =(USE_OUT_ARM_Y_PITCH==iXYPitchVariable || USE_PICKER_COUNT==ep16Picker || USE_IN_OUT_ARM_Y_PITCH==iXYPitchIn_Bb_Out_Bc);   //RogerYang 20260630 : Fix //Ztex 2024.02.24 Add HT-1132   //RogerYang 20251222 : IN/OUT ARM支援不同模組
    MotorOutArmPitchX2->Visible =(USE_OUT_ARM_Y_PITCH==iXYPitchVariable || USE_PICKER_COUNT==ep16Picker || USE_IN_OUT_ARM_Y_PITCH==iXYPitchIn_Bb_Out_Bc);   //RogerYang 20260630 : Fix //Ztex 2024.02.24 Add HT-1132   //RogerYang 20251222 : IN/OUT ARM支援不同模組
    ...
    {
        //close other Item
        for(int i=0;i<grpAOICtrl->ControlCount;i++)
        {
            TControl *Control=grpAOICtrl->Controls[i];
            if(dynamic_cast<TSpeedButton*>(Control) != NULL ||
               dynamic_cast<TEdit*>(Control) != NULL)
            {
        ...
        {
            TControl *Control=GroupBox1->Controls[i];
            if(dynamic_cast<TSpeedButton*>(Control) != NULL ||
               dynamic_cast<TEdit*>(Control) != NULL)
            {
                Control->Visible = false;
        ...
        SetBtnScannerAOI->Caption       ="TopBtm AOI";
        SetBtnScannerAOI->Visible       =true;
        GoBtnScannerAOI->Visible        =true;
        setEditScannerAOIX->Visible     =true;
        setEditScannerAOIY->Visible     =true;
        lblAOI_X->Visible               =true;
        lblAOI_Y->Visible               =true;
        SetBtnScannerAOI_Z->Caption       ="TopBtm AOI Z";
        SetBtnScannerAOI_Z->Visible       =true;
        GoBtnScannerAOI_Z->Visible        =true;
        setEditScannerAOIZ->Visible     =true;
        Label6->Visible                 =true;
        gbTopBtmAOI->Visible            =true;
        FrmAOI->fAOI_ReadFile();
    }
    ...
    MotorTrayZ->Enabled=(TRAY_ARM_MODE==eUnderCoveyor);                         //RogerYang 20250414 Add
    MotorTrayZ->Visible=(TRAY_ARM_MODE==eUnderCoveyor);                         //RogerYang 20250414 Add
    ...
    tsOutSort->TabVisible               =(USE_OUT_SORT_ARM!=eartUninstall);     //RogerYang 20250415 Add for 9046AU
    ...
    {
        grpSortArmAxis->Visible =true;
        grpSortSHTAxis->Visible =true;
        grpSortSHTAxis->Top     =gbOutSh2->Top;
        grpSortSHTAxis->Width   =gbOutSh2->Width;
    }
    ...
    if(In_Shuttle_Auto_Latch==eInSHAutoLtc)                                     //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
    {
        ...
        InSHZDownRange->Text=iInShtZRange;                                      //KenHsieh 20251107 : Add Range for InSHZ 避免初始高度太高造成校正之門檻值過高
    }
    ...
    if(INSTALL_OCR_YMot==eocrYMotInstal)                                        //RogerYang 20260223 : 整合Boat Carrier & Load Y
    {
        ...
        MotorAuto2YCCW->Visible=false;
            ...
            CosFunction.bTrayOCR)                                               //KenHsieh 20260514 : 補上OCR+皮帶
    {
        grpLoadY->Visible=true;
        MotorLoaderYCCW->Visible=false;
        MotorAuto1YCW->Visible=false;
    ...
    if(INSTALL_OCR_YMot==eocrYMotInstal)                                        //Frank 20250214 add
        gbOCRYMot->Visible=true;
    else
        gbOCRYMot->Visible=false;

    if(CUSTOMER_CODE==CC_ASE_CL)
    {
        gbContactRelative->Visible=true;
    }
    else
    {
        gbContactRelative->Visible=false;
    }
...
void __fastcall TfTeach::UpdateTempTech()
{
    ...
    if(USE_OUT_SORT_ARM!=eartUninstall)                                         //RogerYang 20250416 for HT9046AU add
    {
        *TechSuckPara[2].Parameter[0][0]=atoi(TechSuckPara[2].SetEdit[0][0]->Text.c_str());
        *TechSuckPara[2].Parameter[0][1]=atoi(TechSuckPara[2].SetEdit[0][1]->Text.c_str());
    }
}
//---------------------------------------------------------------------------
void __fastcall TfTeach::btnSaveClick(TObject *Sender)
{
    ...
    WriteIniDataGeneral("Shuttle", "iInShtZRange", atoi(InSHZDownRange->Text.c_str()));   //KenHsieh 20251107 : Add Range for InSHZ 避免初始高度太高造成校正之門檻值過高
    iInShtZRange=CheckAndReadIniDataGeneral("Shuttle",  "iInShtZRange"    , 250);         //KenHsieh 20251223 : 避免重新開啟頁面時，未更新元件上的值
    ...
    if(USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall)                    //Jimmychiu 20240322 : Top & Bottom Inspect
    {
        FrmAOI->edTopBtnCenterX->Text=edTopBtnCenterX->Text;
        FrmAOI->edTopBtnCenterY->Text=edTopBtnCenterY->Text;
        FrmAOI->edRotate0->Text=edTopBtnRotate0->Text;
        FrmAOI->edRotate180->Text=edTopBtnRotate180->Text;
        FrmAOI->SetICSmallGrid(0,0,atoi((edLeftTops65X->Text).c_str()));
        FrmAOI->SetICSmallGrid(1,0,atoi((edLeftTops65Y->Text).c_str()));
        FrmAOI->SetICSmallGrid(0,1,atoi((edRightBottoms65X->Text).c_str()));
        FrmAOI->SetICSmallGrid(1,1,atoi((edRightBottoms65Y->Text).c_str()));
        //
        FrmAOI->SetICLargeGrid(0,0,atoi((edLeftTopl65X->Text).c_str()));
        FrmAOI->SetICLargeGrid(1,0,atoi((edLeftTopl65Y->Text).c_str()));
        FrmAOI->SetICLargeGrid(0,1,atoi((edRightTopl65X->Text).c_str()));
        FrmAOI->SetICLargeGrid(1,1,atoi((edRightTopl65Y->Text).c_str()));
        FrmAOI->SetICLargeGrid(0,2,atoi((edLeftBottoml65X->Text).c_str()));
        FrmAOI->SetICLargeGrid(1,2,atoi((edLeftBottoml65Y->Text).c_str()));
        FrmAOI->SetICLargeGrid(0,3,atoi((edRightBottoml65X->Text).c_str()));
        FrmAOI->SetICLargeGrid(1,3,atoi((edRightBottoml65Y->Text).c_str()));
        //
        FrmAOI->spbSave->OnClick(NULL);
    }
    //Isaac 20201110 : Index Y find motor phase
}
//---------------------------------------------------------------------------
...
void __fastcall TfTeach::MotorTrayXClick(TObject *Sender)
{
    ...
    if(PageControl2->ActivePage==TabSheet14)                                    //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
        Ptr->Down=false;
...
void __fastcall TfTeach::setEditLimitClick(TObject *Sender)
{
            ...
            Ptr==setEditOutSht2X)                                               //Steven 2010112 OUT SH2 X 限制
    {
           ...
           MachineTypeChoice==Type_HT1032)
        {
            if(AUTO_EMPTY_COLOR>=3)
            {
                if(SubMachineType==Type_HT9046AU)                               //RogerYang 20250424 Add for HT9046AU
                {
                    fQwertyKey->ShowQwertyKey((TEdit*)Sender, N_INTEGER, 0, true, -45000, -60000);
                }
                else
                {
...
//---------------------------------------------------------------------------
void __fastcall TfTeach::btnSetAllSortArmZClick(TObject *Sender)                //RogerYang 20250416 for HT9046AU add
{
    if(bSortArmAllUp==false)
    {
        ShowMyMessage("Must press 'Sort Z All Up' first", "");
        return;
    }
    bSortArmAllUp=false;
    ...
    for(int i=0; i<OutArm2Suck.iMaxCol; i++)
    {
        SortZEditPtr[i]->Text=MOT[SortArmZIndex[i]].ReadPos();
    }

    iStandZ=atoi(SortZEditPtr[1]->Text.c_str());

    for(int i=0; i<OutArm2Suck.iMaxCol; i++)
    {
        iZ[i]=atoi(SortZEditPtr[i]->Text.c_str())-iStandZ;
        SortZEditPtr[i]->Text=iZ[i];
    }
    SortZEditPtr[1]->Text=0;
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TfTeach::btnSortZAllUpClick(TObject *Sender)                    //RogerYang 20250416 for HT9046AU add
{
    for(int i=0; i<OutArm2Suck.iMaxCol; i++)
    {
        bSortArmZHome[i]=false;
        InitProcessSingleMotorTask(SortArmZIndex[i]);
    }
...
{
    bool bFlag[3]={false, false, false};                                        //RogerYang 20250416 for HT9046AU add Sort Arm Z
    for(int i=0; i<InArmSuck.iMotRow; i++)
    {
        for(int j=0; j<InArmSuck.iMotCol; j++)
        {
...
void TfTeach::SaveFile(bool bSaveByTeach)                                       //Steven 20240501 : Teach改存成ini
{
    ...
    if(USE_OUT_SORT_ARM!=eartUninstall)                                         //RogerYang 20250416 for HT9046AU add
    {
        TechSuckPara[2].SaveToFile(bSaveByTeach);
    }
...
{
    fQwertyKey->ShowQwertyKey((TEdit *)Sender, N_INTEGER, 0, true, MOT[MTrayX].Motor->PSoftLimitP, -5000);
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TfTeach::edtOutSortShtClick(TObject *Sender)                    //RogerYang 20250416 for HT9046AU add
{
    fQwertyKey->ShowQwertyKey((TEdit *)Sender, N_INTEGER, 0, true, MOT[MOutSortSht].Motor->PSoftLimitP, MOT[MOutSortSht].Motor->PSoftLimitN);
}
//---------------------------------------------------------------------------
void __fastcall TfTeach::edtsetSortXPitchClick(TObject *Sender)                 //RogerYang 20250416 for HT9046AU add
{
    fQwertyKey->ShowQwertyKey((TEdit *)Sender, N_INTEGER, 0, true, MOT[MOutSortPitchX].Motor->PSoftLimitP, MOT[MOutSortPitchX].Motor->PSoftLimitN);
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void TfTeach::InitialFormOncetime()
{
    //JimmyChiu 20220927 : Stepper Motor Control in Fix3
    TTopBottomInspect *ttbInsp=FrmAOI->ttbInsp;
    if(USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall && ttbInsp)                    //Jimmychiu 20240322 : Top & Bottom Inspect
    {
        TechTwoPara.push_back(new TECH_TWOPARA(&ttbInsp->tbpiLessThanOrEqual65mm[0].ppPosition.X   ,&ttbInsp->tbpiLessThanOrEqual65mm[0].ppPosition.Y  ,MTopAOIArmX    ,MTopAOIArmY    ,edLeftTops65X        ,edLeftTops65Y     ,"edLeftTops65X"    ,"edLeftTops65Y"   ,sbLeftTopRecs65       ,GosbLeftTopRecs65        ,(USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall)));
        TechTwoPara.push_back(new TECH_TWOPARA(&ttbInsp->tbpiLessThanOrEqual65mm[1].ppPosition.X   ,&ttbInsp->tbpiLessThanOrEqual65mm[1].ppPosition.Y  ,MTopAOIArmX    ,MTopAOIArmY    ,edRightBottoms65X    ,edRightBottoms65Y ,"edRightBottoms65X"    ,"edRightBottoms65Y"   ,sbRightBottoms65      ,GosbRightBottoms65       ,(USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall)));
        TechTwoPara.push_back(new TECH_TWOPARA(&ttbInsp->tbpiMoreThan65mm[0].ppPosition.X          ,&ttbInsp->tbpiMoreThan65mm[0].ppPosition.Y         ,MTopAOIArmX    ,MTopAOIArmY    ,edLeftTopl65X        ,edLeftTopl65Y     ,"edLeftTopl65X"    ,"edLeftTopl65Y"   ,sbLeftTopRecl65       ,GosbLeftTopRecl65        ,(USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall)));
        TechTwoPara.push_back(new TECH_TWOPARA(&ttbInsp->tbpiMoreThan65mm[1].ppPosition.X          ,&ttbInsp->tbpiMoreThan65mm[1].ppPosition.Y         ,MTopAOIArmX    ,MTopAOIArmY    ,edRightTopl65X       ,edRightTopl65Y    ,"edRightTopl65X"    ,"edRightTopl65Y"   ,sbRightTopRecl65      ,GosbRightTopRecl65       ,(USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall)));
        TechTwoPara.push_back(new TECH_TWOPARA(&ttbInsp->tbpiMoreThan65mm[2].ppPosition.X          ,&ttbInsp->tbpiMoreThan65mm[2].ppPosition.Y         ,MTopAOIArmX    ,MTopAOIArmY    ,edLeftBottoml65X     ,edLeftBottoml65Y  ,"edLeftBottoml65X"    ,"edLeftBottoml65Y"   ,sbLeftBottomRecl65    ,GosbLeftBottomRecl65     ,(USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall)));
        TechTwoPara.push_back(new TECH_TWOPARA(&ttbInsp->tbpiMoreThan65mm[3].ppPosition.X          ,&ttbInsp->tbpiMoreThan65mm[3].ppPosition.Y         ,MTopAOIArmX    ,MTopAOIArmY    ,edRightBottoml65X    ,edRightBottoml65Y ,"edRightBottoml65X"    ,"edRightBottoml65Y"   ,sbRightBottoml65      ,GosbRightBottomRecl65    ,(USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall)));
        TechTwoPara.push_back(new TECH_TWOPARA(&ttbInsp->tbCenter.ppPosition.X                     ,&ttbInsp->tbCenter.ppPosition.Y                    ,MTopAOIArmX    ,MTopAOIArmY    ,edTopBtnCenterX      ,edTopBtnCenterY   ,"edTopBtnCenterX"    ,"edTopBtnCenterY"   ,sbSetTopBtnCenter     ,GosbSetTopBtnCenter      ,(USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall)));
        TechPara.push_back(new TECH_PARA(&ttbInsp->iRotate0Pos         ,MTopAOIArmR      ,edTopBtnRotate0    ,"edTopBtnRotate0"   ,sbSetedTopBtnRotate0      ,GosbSetedTopBtnRotate0, (USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall)));
        TechPara.push_back(new TECH_PARA(&ttbInsp->iRotate180Pos       ,MTopAOIArmR      ,edTopBtnRotate180  ,"edTopBtnRotate180" ,sbSetTopBtnRotate180      ,GosbSetTopBtnRotate180, (USE_Scanner_AOI_Inspection==(int)eBtnAOI_TopBottomInstall)));
    }
}
//---------------------------------------------------------------------------
void __fastcall TfTeach::sbShuttleSensorClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TfTeach::InSHZDownRangeClick(TObject *Sender)
{
    fQwertyKey->ShowQwertyKey((TEdit *)Sender, N_INTEGER, 0, true, 0, 500);
}
//---------------------------------------------------------------------------
void __fastcall TfTeach::setEditInSh1LtcSenZ1Click(TObject *Sender)
{
    fQwertyKey->ShowQwertyKey((TEdit *)Sender, N_INTEGER, 0, true, MOT[MInSh1LtcSenZ1].Motor->PSoftLimitP, MOT[MInSh1LtcSenZ1].Motor->PSoftLimitN);
}
//---------------------------------------------------------------------------
void __fastcall TfTeach::setEditInSh1LtcSenZ2Click(TObject *Sender)
{
    fQwertyKey->ShowQwertyKey((TEdit *)Sender, N_INTEGER, 0, true, MOT[MInSh1LtcSenZ2].Motor->PSoftLimitP, MOT[MInSh1LtcSenZ2].Motor->PSoftLimitN);
}
//---------------------------------------------------------------------------
void __fastcall TfTeach::setEditInSh2LtcSenZ1Click(TObject *Sender)
{
    fQwertyKey->ShowQwertyKey((TEdit *)Sender, N_INTEGER, 0, true, MOT[MInSh2LtcSenZ1].Motor->PSoftLimitP, MOT[MInSh2LtcSenZ1].Motor->PSoftLimitN);
}
//---------------------------------------------------------------------------
void __fastcall TfTeach::setEditInSh2LtcSenZ2Click(TObject *Sender)
{
    fQwertyKey->ShowQwertyKey((TEdit *)Sender, N_INTEGER, 0, true, MOT[MInSh2LtcSenZ2].Motor->PSoftLimitP, MOT[MInSh2LtcSenZ2].Motor->PSoftLimitN);
}
//---------------------------------------------------------------------------
