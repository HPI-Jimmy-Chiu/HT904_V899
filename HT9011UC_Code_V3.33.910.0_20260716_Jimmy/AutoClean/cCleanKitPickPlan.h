...
//AI(ht9045-v899) 20260514: refactored to delegate enumeration to generic cArmPickPlan
...
private:
    ...
    //AI(ht9045-v899) 20260514: generic enumeration engine; this class provides context
    ...
    void BuildDemand();
    //AI(ht9045-v899) 20260514: copy generic plan result back into legacy m_Best
    void CopyGenericPlanToBest();
...
public:
    ...
    //AI(ht9045-v899) 20260514: IArmPickPlanContext implementation
