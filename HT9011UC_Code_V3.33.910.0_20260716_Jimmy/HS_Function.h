...
public:     // User declarations
    ...
    void __fastcall RecordLog_HS(bool bAnyWaySend=false, bool bRealTime=false);            //Eastsun 20260511 整合: Ifor 20250123 add: KYEC 要求一直紀錄
    ...
    bool __fastcall Check_FileFolderByFTP();                                    // Eastsun 20260511 整合: Ifor 20240619 add: KYEC FTP folder check
    bool __fastcall ReadMultiEP();                                              // Eastsun 20260511 整合: Ifor 20250417 add: Read Multi EP
    void __fastcall Check_RecordFolder(AnsiString asDirPath, bool bNeedTime=false);  // Eastsun 20260511 整合: Ifor 20250117 add: Check Record Folder
    void __fastcall RecordGroundManLog_HS(AnsiString aFileName);                // Eastsun 20260511 整合: Ifor 20250123 add: KYEC FTP UP Load GroundMan Log File
    bool __fastcall CheckMTKFileName(bool bInitial=false);                      // Eastsun 20260511 整合: Ifor 20241217 add: MTL File Check (T30 依賴)
    bool bFTPRetryUpLoad;                                                        // Eastsun 20260511 整合: Ifor 20240712 add: FTP retry
    bool bFTPRetryPowerSavingUpLoad;                                             // Eastsun 20260511 整合: Ifor 20240712 add
    AnsiString anMultiEPData;                                                    // Eastsun 20260511 整合: Ifor 20250417 add: Multi EP buffer
};
//---------------------------------------------------------------------------
