...
__published:    // IDE-managed Components
    ...
    TTMyTray *mtShuttle1;
    TTabSheet *TabSheet2;
    TGroupBox *gbLaserPanel_OutShuttle1_2;
    TPanel *palLaserValue_OutShuttle1_2;
    TGroupBox *gbLaserPanel_OutShuttle1_1;
    TPanel *palLaserValue_OutShuttle1_1;
    TGroupBox *gbLaserPanel_OutShuttle2_2;
    TPanel *palLaserValue_OutShuttle2_2;
    TGroupBox *gbLaserPanel_OutShuttle2_1;
    TPanel *palLaserValue_OutShuttle2_1;
    TTMyTray *mtOutShuttle2;
    TGroupBox *GroupBox5;
    TTMyTray *mtOutShuttle2_Golden;
    TGroupBox *GroupBox6;
    TTMyTray *mtOutShuttle1_Golden;
    TTMyTray *mtOutShuttle1;
    TTabSheet *TabSheet4;
    TLabel *Label2;
    TLabel *Label3;
    TLabel *Label5;
    TLabel *Label6;
        TLabel *Label4;
        TLabel *Label7;
        TEdit *edDeviceXOffset;
        TEdit *edDeviceYOffset;
    TEdit *edOutDeviceXOffset;
    TEdit *edOutDeviceYOffset;
    TEdit *edInArmDeviceFloatingCheckRange;
    TEdit *edOutArmDeviceFloatingCheckRange;
    TButton *btGetInShuttleGolden;
    TButton *btGetOutShuttleGolden;
    TCheckBox *cbEnableInShuttleFloatingCheck;
    TCheckBox *cbEnableOutShuttleFloatingCheck;
        TComm *CommLaserOutArm;
        TButton *btGetShValue;
        TButton *btGetOutShValue;
    ...
    void __fastcall edDeviceXOffsetMouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall edDeviceYOffsetMouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall edOutDeviceXOffsetMouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
        void __fastcall edOutDeviceYOffsetMouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
        void __fastcall btGetInShuttleGoldenClick(TObject *Sender);
        void __fastcall btGetOutShuttleGoldenClick(TObject *Sender);
        void __fastcall CommLaserOutArmReceiveData(TObject *Sender,
          Pointer Buffer, WORD BufferLength);
    void __fastcall btGetShValueClick(TObject *Sender);
    void __fastcall btGetOutShValueClick(TObject *Sender);
...
public:     // User declarations
    ...
    void __fastcall SaveShuttleLaserValue(int iSht, int iInOutSht=0);  //Eastsun 20260525 laser 整合 : iInOutSht 0=InSht 1=OutSht
