...
__published:    // IDE-managed Components
    ...
    TLabel *lblSht3Servo;
    TALed *ledOut3_Y2;
    TLabel *labOut3_Y2_Axis;
    TLabel *labOut3_Y2_Count;
    TMemo *Memo_Out3Y2;
    TPanel *palInSHAutoLtc;
    TGroupBox *gbInSh1_2Y;
    TLabel *labIn1_2_Y_Axis;
    TLabel *labIn1_2_Y_Count;
    TALed *ledIn1_2_Y;
    TButton *Button5;
    TMemo *Memo_In1_2Y;
    TGroupBox *gbInSh2_2Y;
    TLabel *labIn2_2_Y_Axis;
    TLabel *labIn2_2_Y_Count;
    TALed *ledIn2_2_Y;
    TMemo *Memo_In2_2Y;
    TButton *Button6;
...
private:    // User declarations
    ...
    U16 LatchInputNo6;
    U16 LatchInputNo7;
    U16 LatchInputNo8;                                                          //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
    U16 LatchInputNo9;                                                          //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
...
public:     // User declarations
    ...
    I16 iGetAxisCounterNo8;                                                     //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
    I16 iGetAxisCounterNo9;                                                     //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
    ...
    U16 LatchDataCnt6;
    U16 LatchDataCnt7;
    U16 LatchDataCnt8;                                                          //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
    U16 LatchDataCnt9;                                                          //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
    ...
    I32 LatchDataTable8[1024];                                                  //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
    I32 LatchDataTable9[1024];                                                  //KenHsieh 20250722 : InSht sensor 改為2顆，並用Latch 判別疊料以及飛料
