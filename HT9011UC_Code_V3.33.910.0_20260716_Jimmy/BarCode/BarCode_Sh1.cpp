...
bool TfBarCode::DoBarcodeCCDInShuttle_1(bool bVerify)                           //Steven 20160106 : 改用CCD拍完就跑的方式
{
    ...
    switch(Task)
    {
        ...
        case 1120:
            ...
            {
                //==> Eastsun 20260527 整合#028.AAL.P11a Sh1 case 1120 AAL wrap-head :KYEC
                for(int i=0; i<2; i++)
                {
                    if(CosFunction.bUseBarcodeAutoAdjustLight==true && TestIF_File.bUseBarcodeAutoAdjustLight==true && bStartAutoAdjustLight==true)
                    {
                        if(bBarcodeNeedAutoAdjust[i]==true && (FLCarryKit.Item[i][iNowMoveStep]==HAS_IC || FLCarryKit.Item[i][iNowMoveStep]==HAS_HOT_IC))
                        {
                            ...
                            SendCCDCommand(iBarCodeRowA+i, "AutoAdjustLight 1120: ", sCCDCommand);
                        }
                        else
                        {
	            ...
	            //==> Eastsun 20260527 整合#028.AAL.P11b Sh1 case 1120 AAL wrap-tail :KYEC
	            }
            //<== Eastsun 20260527 整合#028.AAL.P11b
            }
            break;
        //==> Eastsun 20260527 整合#028.AAL.P12 Sh1 case 1121 AAL exposure wait :KYEC
        case 1121:
        ...
        case 1300:
            ...
            if(dVisionVer>=2)                                                   //wei 20170119 (Steven) 版本號大於2
            {
                //==> Eastsun 20260527 整合#BCIR.P11 toggle GG/GV :KYEC
...
//------------------------------------------------------------------------------
bool TfBarCode::DoBarcodeScanInShuttle_1(bool bErrorSkip)
{
    ...
    switch(Task)
    {
        ...
        case 1150:
               ...
               bBarcodeNum[iBarCodeRowB]==true)
            {
                //Steven 20260423 : DBG-C case1150 -> 1200
                {
                    ...
                    AddCCDCommunicationLog(iBarCodeRowA, _dbgC);
                }
                Task=1200;
        ...
        case 1180:
            {
                ...
                AddCCDCommunicationLog(iBarCodeRowA, _dbgE);
            }
            bMoveOK=false;
        ...
        case 1200:
            ...
            //<== Eastsun 20260526 #026-4.PinN.Sh1-5
            {
                ...
                AddCCDCommunicationLog(iBarCodeRowA, _dbgD);
                for(int _r=0; _r<InArmSuck.iShtRow; _r++)
                {
                    ...
                    {
                        _dbgGrid+=AnsiString(" [")+AnsiString(_c)+"]=\""+mtBarcodeInSh->GetCellText(_r, _c+1)+"\"";
                    }
                    AddCCDCommunicationLog(iBarCodeRowA, _dbgGrid);
                }
                ...
                for(int _r=0; _r<InArmSuck.iShtRow; _r++)
                {
                    ...
                    AddCCDCommunicationLog(iBarCodeRowA, _dbgRow);
                }
            }
