...
public:     // User declarations
    ...
    bool OEE_StartLot(bool bSilent=false, AnsiString *pasErrorMsg=NULL);        //AI(ht9045-v899) 20260504: allow OLP LotInfo to receive OEE start errors without modal dialogs
