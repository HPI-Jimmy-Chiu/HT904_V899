...
__published:    // IDE-managed Components
    ...
    void __fastcall edP40_1Click(TObject *Sender);                          //JerryYang 20191001 loader跛動馬達
    void __fastcall edP40_2DblClick(TObject *Sender);                       //JerryYang 20191001 loader跛動馬達
    void __fastcall edP40_3Click(TObject *Sender);                          //JerryYang 20191001 loader跛動馬達
