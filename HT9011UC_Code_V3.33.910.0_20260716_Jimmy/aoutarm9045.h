...
int  GetOutArmXToSortShtOffset(int iOffsetPos);                                 //RogerYang 20250515 Add for 9046AU
int  GetOutArmYToSortShtOffset(int iOffsetPos);
bool NeedPlaceToSort();
extern void SetSortShuttleStatus_Place(int iShtRow, int iShtCol, int iSuckRow, int iSuckCol);
...
bool DoFixTrayFullAlarm(bool bCheckFixStatus=false);                            //Eastsun 20260710整合
