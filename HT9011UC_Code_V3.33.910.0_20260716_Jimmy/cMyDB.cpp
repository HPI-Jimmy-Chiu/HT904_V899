...
void __fastcall SaveEventTracker(AnsiString aAlarmCode, AnsiString aMess, int iType, AnsiString aStatus)
{
    ...
    AnsiString S, aHandler=" ", aRecipe=" ", aLotName=" ", LotInName=" ", aJamStartTime=" ", aJamStartDate=" ", aSubject=" ", aMessage=" ",
               Target, aJamReStartTime=" ", aDownTime=" ", aUPH=" ", aTesterID=" ", aSwVersion=" ", aSiteID=" ", aProjectID=" ";
    AnsiString str, str1, aTargetPath, aPath;
