object fLotInfo: TfLotInfo
  ...
  object pgLotinfo: TPageControl
    ...
    object tsLotID: TTabSheet
      ...
      object Panel8: TPanel
        ...
        object palSecsGem: TPanel
          ...
          object labBarcodeRecipe: TLabel
            Left = 14
            Top = 212
            Width = 77
            Height = 13
            Caption = 'Barcode Recipe'
            Visible = False
          end
        ...
        object palAQLMode: TPanel
          ...
          TabOrder = 3
          Visible = False
          object lbLotAQLCount: TLabel
            Left = 4
            Top = 12
            Width = 124
            Height = 20
            Caption = 'AQL Set Counts :'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clNavy
            Font.Height = -16
            Font.Name = 'MS Sans Serif'
          ...
          object lbLotAQLSetCount: TLabel
            Left = 132
            Top = 12
            Width = 54
            Height = 20
    ...
    object tsSelection: TTabSheet
      ...
      object Panel14: TPanel
        ...
        object groupbDownloadItem: TGroupBox
          ...
          ParentFont = False
          TabOrder = 0
          object lblDownloadAccessWarning: TLabel
            Left = 63
            Top = 12
            Width = 152
            Height = 13
    ...
    object tsASECLEventLog: TTabSheet
      ...
      object Panel10: TPanel
        ...
        object pnlLotInfo_ASECL: TPanel
          ...
          object cbRunModeASECL: TComboBox
            Left = 127
            Top = 160
            Width = 121
            Height = 24
    ...
    object tsKYEC_AMR: TTabSheet
      Caption = 'KYEC AMR'
      ImageIndex = 23
      object ledStartAGV: TALed
        Left = 335
        Top = 286
        Width = 22
        Height = 14
      ...
      object ledLoaderTotalTray: TALed
        Left = 335
        Top = 337
        Width = 22
        Height = 14
      ...
      object paLoaderTotalTray: TPanel
        Left = 212
        Top = 334
        Width = 120
        Height = 20
        Caption = 'LoaderTotalTray'
        Color = clSkyBlue
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object Panel36_KYEC: TPanel
        ...
        ParentColor = True
        TabOrder = 4
        object lblAMRSpacer_KYEC: TLabel
          Left = 121
          Top = 141
          Width = 3
          Height = 13
        end
        object labNowAuto1TrayID_KYEC: TLabel
          Left = 120
          Top = 47
          Width = 15
          Height = 13
        ...
        object labNowAuto2TrayID_KYEC: TLabel
          Left = 120
          Top = 62
          Width = 15
          Height = 13
        ...
        object labNowAuto3TrayID_KYEC: TLabel
          Left = 120
          Top = 77
          Width = 15
          Height = 13
        ...
        object labAuto1TrayCount_KYEC: TLabel
          Left = 121
          Top = 111
          Width = 6
          Height = 13
        ...
        object labAuto2TrayCount_KYEC: TLabel
          Left = 121
          Top = 126
          Width = 6
          Height = 13
        ...
        object labAuto3TrayCount_KYEC: TLabel
          Left = 121
          Top = 142
          Width = 6
          Height = 13
        ...
        object Label52_KYEC: TLabel
          Left = 14
          Top = 32
          Width = 102
          Height = 13
          Caption = 'Loader Now Tray ID :'
        end
        object labNowLoaderTrayID: TLabel
          Left = 120
          Top = 32
          Width = 15
          Height = 13
        ...
        object Label56_KYEC: TLabel
          Left = 15
          Top = 96
          Width = 103
          Height = 13
          Caption = 'Loader Tray Count    :'
        end
        object labLoaderTrayCount: TLabel
          Left = 121
          Top = 95
          Width = 6
          Height = 13
        ...
        object labLotTrayCount_KYEC: TLabel
          Left = 121
          Top = 166
          Width = 6
          Height = 13
        ...
        object Label58_KYEC: TLabel
          Left = 141
          Top = 165
          Width = 98
          Height = 13
          Caption = 'Now Tray Count      :'
        end
        object labNowTrayCount: TLabel
          Left = 242
          Top = 166
          Width = 6
          Height = 13
          Caption = '0'
          OnClick = labNowTrayCountClick
        end
        object Label59_KYEC: TLabel
          Left = 262
          Top = 165
          Width = 92
          Height = 13
          Caption = 'Diff Tray Count      :'
        end
        object LabDiffTrayCount: TLabel
          Left = 361
          Top = 166
          Width = 6
          Height = 13
      ...
      object btnAMRSupplement: TButton
        Left = 0
        Top = 344
        Width = 75
        Height = 25
        Caption = 'Supplement'
        TabOrder = 6
        OnClick = btnAMRSupplementClick
      end
      object btnAMRLDUnLDCheck: TButton
        Left = 0
        Top = 376
        Width = 75
        Height = 25
        Caption = 'Check'
        TabOrder = 7
        OnClick = btnAMRLDUnLDCheckClick
      end
      object btnAMRLDUnLDFinish: TButton
        Left = 0
        Top = 408
        Width = 75
        Height = 25
        Caption = 'Finish'
        TabOrder = 8
        OnClick = btnAMRLDUnLDFinishClick
      end
      object edAMREventParam: TEdit
        Left = 0
        Top = 312
        Width = 121
        Height = 21
      ...
      object edAMRLoaderTrayID: TEdit
        Left = 96
        Top = 344
        Width = 100
        Height = 21
      ...
      object btnAMRClearCount: TButton
        Left = 32
        Top = 280
        Width = 75
        Height = 25
        Caption = 'Clear Count'
        TabOrder = 14
        OnClick = btnAMRClearCountClick
      end
      object btnAMRSetSECS: TButton
        Left = 0
        Top = 480
        Width = 75
        Height = 25
        Caption = 'Set SECS'
        TabOrder = 15
        OnClick = btnAMRSetSECSClick
      end
      object edAMRTrayCount: TEdit
        Left = 96
        Top = 456
        Width = 100
        Height = 21
  ...
  object ATCTransferFileTime: TTimer
    OnTimer = ATCTransferFileTimeTimer
    Left = 384
    Top = 500
  end
end
