...
__published:    // IDE-managed Components
    ...
    void __fastcall ed_PClick(TObject *Sender);
        void __fastcall FileSocketConnect(TObject *Sender,
          TCustomWinSocket *Socket);
        void __fastcall FileSocketDisconnect(TObject *Sender,
          TCustomWinSocket *Socket);
        void __fastcall FileSocketError(TObject *Sender,
          TCustomWinSocket *Socket, TErrorEvent ErrorEvent,
          int &ErrorCode);
        void __fastcall FileSocketRead(TObject *Sender,
          TCustomWinSocket *Socket);
...
public:     // User declarations
    ...
    int iTransferFileDleayCount;                                                //Eastsun 20260522 整合
    ...
    void __fastcall ATC_Recipe_FileTransfer(AnsiString asFileSend);             //Eastsun 20260522 整合//Ifor 20251229 add: ATC Rrcipe 傳送與接收
    void __fastcall GET_ATC_Recipe();                                           //Eastsun 20260522 整合

    bool __fastcall IS_ATC33();                                                 //Steven 20260716 : 整合ATC 3.3 / 3.5 / 3.6
};
//---------------------------------------------------------------------------
