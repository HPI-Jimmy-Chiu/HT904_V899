...
//------------------------------------------------------------------------------
//bool DoFixTrayFullAlarm()                                                       //Steven 20181113 : 修正Fix Link Alarm的問題    //Eastsun 20260710整合
bool DoFixTrayFullAlarm(bool bCheckFixStatus)                                  //Eastsun 20260710整合
{
    bool bResult=true;
    bool bScan1By1=false;
    int iAuto, iFix=iAutoIndex[iWhichAuto];
//    AnsiString str, s;
    AnsiString str, s;                                                         //Eastsun 20260710整合
    int iData, iFixData;                                                       //Eastsun 20260710整合
...
//==============================================================================
const int iArrivalGap=10;
//------------------------------------------------------------------------------
bool IsMotorArrival(int iMot,int iTargetPos)                                    //Jimmychiu 20240726 : Fill The Tray After Out Arm Place
{
    bool b=TMyMotor().CheckArmPosArrival(iTargetPos, MOT[iMot].ReadPos(), iArrivalGap);
    return b;
}
//==============================================================================
...
//------------------------------------------------------------------------------
int iOutArmIonFanGiveWayTask;
void InitDoOutArmIonFanGiveWayTask()                                            //Eastsun 20260521 整合
{
    iOutArmIonFanGiveWayTask=1;
}
//------------------------------------------------------------------------------
bool DoOutArmIonFanGiveWay()                                                    //Eastsun 20260521 整合
{
    bool bResult=false;
...
//------------------------------------------------------------------------------
bool MoveOutArmXY_To_ESDSafePos()                                               //Eastsun 20260521 整合
{
    int iXPos=0, iYPos=0;
    int iXVariable[X_PITCH_COUNT];
    int iYVariable=0;
