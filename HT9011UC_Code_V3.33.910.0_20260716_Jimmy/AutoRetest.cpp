        ...
        case 300:                                                               //移動到Auto 上面
            ...
            if(ret && bC_Auto_Fixer_Off[Pos])
            {
                ...
                if(CUSTOMER_CODE==CC_KYEC_LEE &&
                   //MOT[iMMAuto[Pos]].Tray.HasRealIC()==false)                   //wei 20160203 回盤為空盤不計數 //Eastsun 20260710 Merge
                   MOT[iMMAuto[Pos]].Tray.HasRealIC()==false &&
                   !TrayForm.bEnableAMR)                                       //Eastsun 20260710 Merge
                    iRetestNoIC[Pos]++;
            }
            break;
        case 350:
...
bool DoAuto_AutoRT(int Pos, bool bReset)                                        //ChungHung 20141002 add for KYEC AutoRetest
{
    ...
    switch(Task)
    {
        ...
        case 200:                                                               //入Tray到機台裡面
            ...
            if(iUnloaderTrayCountCal[Pos]>0)                            //Eastsun 20260710 auto 盤數 ART 時要扣除 //Eastsun 20260710 Merge ADD
