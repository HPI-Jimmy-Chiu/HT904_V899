object fTrayAssignment: TfTrayAssignment
  ...
  object GroupBox2_KYEC: TGroupBox
    Left = 1252
    Top = 429
    Width = 222
    Height = 317
    ...
    object lblAMR_TrayNo_KYEC: TLabel
      Left = 59
      Top = 38
      Width = 52
      Height = 16
    ...
    object lblAMR_IDUse_KYEC: TLabel
      Left = 145
      Top = 36
      Width = 41
      Height = 16
    ...
    object lblAMR_FullTrayCountCap_KYEC: TLabel
      Left = 12
      Top = 148
      Width = 95
      Height = 16
    ...
    object lblAMR_InputTrayCountCap_KYEC: TLabel
      Left = 12
      Top = 218
      Width = 102
      Height = 16
    ...
    object lblAMR_LotTrayCountCap_KYEC: TLabel
      Left = 12
      Top = 242
      Width = 92
      Height = 16
    ...
    object cbAMRTray1st_KYEC: TComboBox
      Left = 50
      Top = 58
      Width = 70
      Height = 24
    ...
    object cbAMRTray2nd_KYEC: TComboBox
      Left = 50
      Top = 88
      Width = 70
      Height = 24
    ...
    object cbAMRTray3rd_KYEC: TComboBox
      Left = 50
      Top = 117
      Width = 70
      Height = 24
    ...
    object cbAMRTrayID1st_KYEC: TComboBox
      Left = 130
      Top = 58
      Width = 70
      Height = 24
    ...
    object cbAMRTrayID2nd_KYEC: TComboBox
      Left = 130
      Top = 88
      Width = 70
      Height = 24
    ...
    object cbAMRTrayID3rd_KYEC: TComboBox
      Left = 130
      Top = 117
      Width = 70
      Height = 24
    ...
    object edAMRFullTrayCount_KYEC: TEdit
      Left = 119
      Top = 144
      Width = 49
      Height = 24
    ...
    object cbEnableAMR_KYEC: TCheckBox
      Left = 12
      Top = 18
      Width = 172
      Height = 17
      Caption = 'Enable AMR'
      TabOrder = 7
      OnClick = cbEnableAMR_KYECClick
    end
    object rgAMRReaderPos_KYEC: TRadioGroup
      Left = 13
      Top = 170
      Width = 188
      Height = 39
    ...
    object edAMRInputTrayCount_KYEC: TEdit
      Left = 119
      Top = 214
      Width = 49
      Height = 24
    ...
    object cbEnableAMRLoader_KYEC: TCheckBox
      Left = 12
      Top = 264
      Width = 172
      Height = 17
      Caption = 'Enable AMR Loader'
      TabOrder = 10
    end
  end
