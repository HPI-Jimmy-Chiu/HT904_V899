...
__published:    // IDE-managed Components
    ...
    TButton *btnSortFix6;
        ...
        TLabel *LabOffsetOX;
        TLabel *LabOffsetOY;
    TTabSheet *ts_Offset_HotTempShiftOffset;
    TTabSheet *tsScale;
    TCheckBox *chkInArmScakeEnable;
    TGroupBox *GroupBox5;
    TGroupBox *GroupBox6;
    TLabel *Label20;
    TLabel *Label21;
    ...
    TEdit *edt_HP2X;
    TPanel *palE32;
    TCheckBox *chkOutArmScakeEnable;
    ...
    TEdit *ed_IS2Y;
    TEdit *ed_IS2X;
    TTabSheet *tsZCalibration;
    TSpeedButton *sbInArmZCalibration;
    TSpeedButton *sbOutArmZCalibration;
    TSpeedButton *sbZcalibration;
    TStringGrid *sg_Offset_HotTempShiftOffset;
    ...
    void __fastcall sbZcalibrationClick(TObject *Sender);
    void __fastcall sbInArmZCalibrationMouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall sbOutArmZCalibrationMouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall edLodXClick(TObject *Sender);
...
public:     // User declarations
    ...
    void __fastcall ReadInvisibleFile(AnsiString szDir2);
    ...
    void __fastcall LoadLoaderScaleValues();
    int __fastcall LoadASECLOffsetIndexValues(int iType,int iPos);
    void __fastcall WriteHotTempShiftOffsetData();
    void CopyStringGridAsTabFormat(TStringGrid *strGrd,TStringList *memoPtr);
    bool __fastcall ReadHotTempShiftOffsetData();
...
void SetTempShiftOffsetPeriod(int CurrentTemp,AnsiString aCurrentSetupFile);    //pig 20240215 AddTempShiftOffset
//---------------------------------------------------------------------------
#endif
