...
void DoTestIFConvert()
{
    ...
    TestIF.dMulti2DSH1Ofs_L = iUnitMultiply100(TestIF_File.dMulti2DSH1Ofs_L);   //KenHsieh 20240628 : 補上Multi Barcode Offset
    TestIF.dMulti2DSH1Ofs_R = iUnitMultiply100(TestIF_File.dMulti2DSH1Ofs_R);   //KenHsieh 20240628 : 補上Multi Barcode Offset
    TestIF.dMulti2DSH2Ofs_L = iUnitMultiply100(TestIF_File.dMulti2DSH2Ofs_L);   //KenHsieh 20240628 : 補上Multi Barcode Offset
    TestIF.dMulti2DSH2Ofs_R = iUnitMultiply100(TestIF_File.dMulti2DSH2Ofs_R);   //KenHsieh 20240628 : 補上Multi Barcode Offset
...
void DoHotPlateConvert()
{
    ...
    if(HotPlateForm_File.XPitch==26.67)                                         //Steven 2020260716 : 26.67 x 3 = 8001
    {
        HotPlateForm.XPitch = iUnitMultiply100(26.66);
    }
    else
    {
