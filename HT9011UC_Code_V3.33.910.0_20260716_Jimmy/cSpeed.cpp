...
//    }
    ...
    WriteIniData(szDir, "Input Arm", "PrecisorOpenSpeed",      edPrecisorOpenSp->Text);                                 //JerryYang 20250120 : add
    WriteIniData(szDir, "Input Arm", "PrecisorCloseSpeed",      edPrecisorCloseSp->Text);
    ...
    WriteIniData(szDir, "Shuttle", "Shuttle Sort Speed",        edSht2Spd->Text);                                       //RogerYang 20250514 Add for 9046AU 暫時用Shuttl2的速度
    WriteIniData(szDir, "Shuttle", "Shuttle Sort Accel",        edSht2Acc->Text);
