...
__published:    // IDE-managed Components
    ...
    TEdit *edtRange2;
    TEdit *edtRange3;
        TGroupBox *gbACTTCPIP;
        TLabel *Label17;
        TLabel *Label18;
        TEdit *edACTIPAddress;
        TEdit *edACTPort;
        TBitBtn *btConnect;
        TBitBtn *btDisConnect;
        TButton *btACTTrigger;
        TEdit *edACTCMD;
        TClientSocket *ClientSocketACT;
        TTimer *ACTConnectTimer;
    ...
    void __fastcall edtCheckIntervalTimeMouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
        void __fastcall btACTTriggerClick(TObject *Sender);
        void __fastcall btConnectClick(TObject *Sender);
        void __fastcall btDisConnectClick(TObject *Sender);
        void __fastcall ClientSocketACTRead(TObject *Sender,
          TCustomWinSocket *Socket);
        void __fastcall ACTConnectTimerTimer(TObject *Sender);
private:    // User declarations
    bool SaveCommData( const TComm* Comm );
    bool LoadCommData(TComm* Comm );
    void ShowDefaultPos(bool bHide=false);
    AnsiString CommName;
    void __fastcall ReceiceData(AnsiString Str); //Eastsun 20260525 TACT splice
