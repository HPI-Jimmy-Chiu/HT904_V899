...
double MultiTransferKG(double fKpa, bool bDualForce=false);  //Eastsun 20260710 Merge                        //AI(ht9045-v899) 20260504: Multi EP per-site Kpa->Kg (ported from V896 Ifor 20250416).
