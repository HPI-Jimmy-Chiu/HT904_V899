...
EXP DWORD CALLBACK DNM100_GetExplicitMSGRespValue(BYTE BoardNo,BYTE DesMACID,WORD *DataLen,WORD *DATA);     //Sam 20180808 : BYTE > WORD
...
//EXP DWORD CALLBACK DNM100_SendExplicitMSG(BYTE BoardNo,BYTE DesMACID,BYTE ServiceID,WORD ClassID,WORD InstanceID,BYTE DataLen,BYTE *DATA);
