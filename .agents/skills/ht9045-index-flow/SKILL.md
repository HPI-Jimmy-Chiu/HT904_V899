...
DoTestYFront / DoTestYRear / DoTestY_TwoArm32Site / DestroyIC / SuckTestIC / IndexEveryTimeCheckEP 的完整 case list 均在：

→ [references/child-state-machines.md](references/child-state-machines.md)
