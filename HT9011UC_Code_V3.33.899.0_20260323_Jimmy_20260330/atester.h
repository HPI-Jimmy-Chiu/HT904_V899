...
extern void ProcessCount(int Index);
...
bool IndexCheckOneByOne(bool bReset, int iWhichArm, int iSiteCount, bool bNeedUpCheck=false);   //Ifor 20200617 : add Use One By One Index Check Function 整合
