...
//Comm Port-------------------------                                            //Steven 20120217 : Com Port改成可定義
    ...
    edtOutSortXPitchMin->Text   =CheckAndReadIniDataGeneral("OutSortArm", "USE_OUT_SORT_X_PITCH_MIN", AnsiString("1500"));
...
//----------------------------------
    ...
    WriteIniDataGeneral("TrayY", "EMPTY_Y_USE_MOTOR", false);
    WriteIniDataGeneral("TrayY", "COLOR_Y_USE_MOTOR", false);
    WriteIniDataGeneral("TrayY", "AUTO1_Y_USE_MOTOR", false);
    WriteIniDataGeneral("TrayY", "AUTO2_Y_USE_MOTOR", false);
    WriteIniDataGeneral("TrayY", "AUTO3_Y_USE_MOTOR", false);
...
//Steven 20111011 : 使用16個Heater
    ...
    WriteIniDataGeneral("TempCtrl", "HEATER_CTRL_TYPE",  rgHeaterType->ItemIndex);      //Steven 20141030 : 新增OMRON E5DC溫控器
