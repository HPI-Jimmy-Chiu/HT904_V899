    ...
    {                                                                           //Steven 20140620 : Jovie說畫面要有溫控器對應位置
        ...
        switch(TestIF.iTestMode)
        {
            case SingleSite:
                ...
                break;
            case DualSite:                                                      //1x2
                if(TestIF_File.bUse1x3SiteKit==true &&                          //KevinC 20260109 : 1x2Site and 2x2 NN mode 使用1x3Site Kit
                   Temperature.bATCActiveCooling==true)
                {
                    myTempPal[tcAa1]->Caption="A1 (Aa1)";
                    myTempPal[tcAc1]->Caption="E1 (Ac1)";
                ...
                else if(TestIF_File.bUse1x3SiteKit==true)                       //KevinC 20260109 : 1x2Site and 2x2 NN mode 使用1x3Site Kit
                {
                    myTempPal[tcAa1]->Caption="A1 (Aa1)";
                    myTempPal[tcAc1]->Caption="E1 (Ac1)";
...
{
    fQwertyKey->ShowQwertyKey((TEdit *)Sender, N_DOUBLE, 2, true, (double)300.0, (double)-300.0);  //JerryYang 20231016 : Add handler端設定TJ參數(Slope、Offset)
}
//---------------------------------------------------------------------------
    ...
    else
    {
        ...
        if(iATC_Use_Heat_Count==4)
        {
            if(FTestSuck.iShtRow==1)                                            //1x1, 1x2
            {
                ...
                iSiteToOfs[1][0][0] =16;        iSiteToOfs[1][0][0] =24;
            }
            else                                                                //2x1
            {
                //Aa1
