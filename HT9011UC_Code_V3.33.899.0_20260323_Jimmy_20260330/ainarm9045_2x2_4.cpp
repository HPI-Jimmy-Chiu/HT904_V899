            ...
            if(MoveInArmZToPlateSafe(Task))
            {
                for(int i=0; i<2; i++)
                {
                    for(int j=0; j<4; j++)
                    {
                        ...
                        if(TestIF.iSiteMap[i][j2]!=0 &&                         //KevinC 20250912 : 0 --> i 吸嘴改為AxEx後的路徑
...
//            goto IN_ARM_SHUTTLE_2x2_4;
        ...
        case 1200:
            ...
            //AI(ht9045-v899) 20260407: align with 2x4_8 baseline — add bCheckInarmPlaceShuttle guard
            bCheckInarmPlaceShuttle=true;
            for(int i=0; i<2; i++)
            {
                for(int j=0; j<4; j++)
                {
