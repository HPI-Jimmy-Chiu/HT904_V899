...
//                ZeroMemory(CommandStr, sizeof(CommandStr));
        ...
        else if(S.AnsiPos("CLEAN_AUTO_SORT_COUNT")==1)                          //Ifor 20171016 : add RETEST AUTO SORT COUNT
        {
