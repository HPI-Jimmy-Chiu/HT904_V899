...
| F11 | MG-W14 的 acatchtray:1221/2007 兩條（TrayArm case 570 防抖 iCnt>100） | **V910 已有更演進的公司版本**（Eastsun 20260515/20260710：同名 static iCnt＋KYEC 可設定門檻 iTrayDetectCount＋bCoverTrayInProgress guard）。照搬 V899 的無條件 iCnt>100 會 (a) 丟掉 cover-tray guard (b) 把 KYEC 可調門檻硬編碼 (c) 其餘客戶由立即報警變 100 次防抖——無安全機械合併解 | (a) 尊重 V910 演進不搬（正交的 SKIP 補釋放夾爪已單獨搬） (b) 人工合併兩版語意（新寫碼） | **建議 (a) 不搬**，已照建議執行 |
